...
Focus on contracts as the correct approach, you should declaratively say what you want the code to do in the contracts and let a formal logic engine execute that
