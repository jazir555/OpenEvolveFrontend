...
} from "./chunk-4F63CRL5.js";
import "./chunk-TEWLCXPR.js";
import {
  shallow$1
} from "./chunk-SMR3JHAJ.js";
import "./chunk-WN2TFXBY.js";
import "./chunk-PA2GZSMJ.js";
import {
  require_jsx_runtime
...
// ../../node_modules/.pnpm/@xyflow+react@12.8.6_@types_88e002e015f22491d5f34775505c9e97/node_modules/@xyflow/react/dist/esm/index.js
...
// ../../node_modules/.pnpm/@xyflow+system@0.0.70/node_modules/@xyflow/system/dist/esm/index.js
var errorMessages = {
...
var Panel = (0, import_react.forwardRef)(({ position = "top-left", children: children2, className, style: style2, ...rest }, ref) => {
...
function createSimpleBezierEdge(params) {
  return (0, import_react.memo)(({ id: id2, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style2, markerEnd, markerStart, interactionWidth }) => {
...
function createSmoothStepEdge(params) {
  return (0, import_react.memo)(({ id: id2, sourceX, sourceY, targetX, targetY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style2, sourcePosition = Position.Bottom, targetPosition = Position.Top, markerEnd, markerStart, pathOptions, interactionWidth }) => {
...
function createStepEdge(params) {
  return (0, import_react.memo)(({ id: id2, ...props }) => {
    const _id = params.isInternal ? void 0 : id2;
    return (0, import_jsx_runtime.jsx)(SmoothStepEdge, { ...props, id: _id, pathOptions: (0, import_react.useMemo)(() => ({ borderRadius: 0, offset: props.pathOptions?.offset }), [props.pathOptions?.offset]) });
  });
}
...
function createStraightEdge(params) {
  return (0, import_react.memo)(({ id: id2, sourceX, sourceY, targetX, targetY, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style2, markerEnd, markerStart, interactionWidth }) => {
...
function createBezierEdge(params) {
  return (0, import_react.memo)(({ id: id2, sourceX, sourceY, targetX, targetY, sourcePosition = Position.Bottom, targetPosition = Position.Top, label, labelStyle, labelShowBg, labelBgStyle, labelBgPadding, labelBgBorderRadius, style: style2, markerEnd, markerStart, pathOptions, interactionWidth }) => {
...
var createStore = ({ nodes, edges, defaultNodes, defaultEdges, width, height, fitView, fitViewOptions, minZoom, maxZoom, nodeOrigin, nodeExtent }) => createWithEqualityFn((set3, get3) => {
...
function useInternalNode(id2) {
  const node = useStore((0, import_react.useCallback)((s) => s.nodeLookup.get(id2), [id2]), shallow$1);
  return node;
}
