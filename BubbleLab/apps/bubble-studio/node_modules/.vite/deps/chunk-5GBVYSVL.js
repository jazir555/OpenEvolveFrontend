// ../../node_modules/.pnpm/@tanstack+router-devtools-c_58a53f60bf98dd20dd959f1e7b54b1f3/node_modules/@tanstack/router-devtools-core/dist/index-znsFa8JN.js
var sharedConfig = {
  context: void 0,
  registry: void 0,
  effects: void 0,
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        Devtools = lazy(() => import("./FloatingTanStackRouterDevtools-DLsVEFsK-SPI22YFZ.js"));
  ...
  mount(el) {
    ...
    const dispose2 = render(() => {
      ...
      if (this.#Component) {
        ...
        BaseTanStackRouterDevtoolsPanel = lazy(() => import("./BaseTanStackRouterDevtoolsPanel-DYX5cXun-SWN4XEUO.js").then((n) => n.c));
...
//# sourceMappingURL=chunk-5GBVYSVL.js.map
