/**
 * AIAgentBubble Test Suite
 *
 * Comprehensive tests for ai-agent service bubble
 *
 * Test Coverage:
...
import { AIAgentBubble } from '../service-bubbles/ai-agent-bubble';
...
describe('AIAgentBubble', () => {
  ...
  describe('1. Base Class Inheritance', () => {
    it('should extend ServiceBubble properly', () => {
      ...
      expect(bubble.constructor.name).toBe('AIAgentBubble');
      expect(typeof bubble.action).toBe('function');
    });

    it('should have correct static properties', () => {
      expect(AIAgentBubble.service).toBe('openevolve');
      expect(AIAgentBubble.bubbleName).toBe('ai-agent');
  ...
  describe('7. Request Deduplication', () => {
    ...
    it('should not deduplicate different requests', async () => {
      const bubble1 = new AIAgentBubble({
        operation: 'test1',
        model: 'gpt-4'
      } as any);

      const bubble2 = new AIAgentBubble({
        operation: 'test2',
        model: 'gpt-4'
      } as any);
