/**
 * ApifyBubble Test Suite
 *
 * Comprehensive tests for apify service bubble
 *
 * Test Coverage:
...
import { ApifyBubble } from '../service-bubbles/apify-bubble';
...
describe('ApifyBubble', () => {
  ...
  describe('1. Base Class Inheritance', () => {
    it('should extend ServiceBubble properly', () => {
      ...
      expect(bubble.constructor.name).toBe('ApifyBubble');
      expect(typeof bubble.action).toBe('function');
    });

    it('should have correct static properties', () => {
      expect(ApifyBubble.service).toBe('openevolve');
  ...
  describe('7. Request Deduplication', () => {
    ...
    it('should not deduplicate different requests', async () => {
      const bubble1 = new ApifyBubble({
        operation: 'test1',
        
      } as any);

      const bubble2 = new ApifyBubble({
        operation: 'test2',
