/**
 * PostgreSQLBubble Test Suite
 *
 * Comprehensive tests for postgresql service bubble
 *
 * Test Coverage:
...
import { PostgreSQLBubble } from '../service-bubbles/postgresql-bubble';
...
describe('PostgreSQLBubble', () => {
  ...
  describe('1. Base Class Inheritance', () => {
    it('should extend ServiceBubble properly', () => {
      ...
      expect(bubble.constructor.name).toBe('PostgreSQLBubble');
      expect(typeof bubble.action).toBe('function');
    });

    it('should have correct static properties', () => {
      expect(PostgreSQLBubble.service).toBe('openevolve');
  ...
  describe('7. Request Deduplication', () => {
    ...
    it('should not deduplicate different requests', async () => {
      const bubble1 = new PostgreSQLBubble({
        operation: 'test1',
        host: 'localhost',
        port: '5432'
      } as any);

      const bubble2 = new PostgreSQLBubble({
        operation: 'test2',
        host: 'localhost',
        port: '5432'
      } as any);
