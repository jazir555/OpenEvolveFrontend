 ...
 *
 * Comprehensive tests for qdrant service bubble
 *
 * Test Coverage:
...
describe('QdrantBubble', () => {
  ...
  describe('7. Request Deduplication', () => {
    ...
    it('should not deduplicate different requests', async () => {
      const bubble1 = new QdrantBubble({
        operation: 'test1',
        baseUrl: 'http://localhost:6333',
        vectorSize: '1536'
      } as any);

      const bubble2 = new QdrantBubble({
        operation: 'test2',
        baseUrl: 'http://localhost:6333',
        vectorSize: '1536'
      } as any);
  ...
  describe('11. Edge Cases and Boundary Conditions', () => {
    ...
    it('should handle special characters in parameters', async () => {
      const bubble = new QdrantBubble({
        operation: 'test',
        baseUrl: 'http://localhost:6333_test-123',
        vectorSize: '1536_test-123'
      } as any);
