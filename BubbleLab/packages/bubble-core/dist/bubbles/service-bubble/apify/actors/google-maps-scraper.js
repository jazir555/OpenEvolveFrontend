...
export const GoogleMapsScraperInputSchema = z.object({
    searchStringsArray: z
        ...
        .describe('Search queries for Google Maps. Examples: ["restaurants in New York", "hotels in Paris"]'),
    locationQuery: z
        .string()
        .optional()
...
const GoogleMapsAdditionalInfoSchema = z.record(z.string(), z.array(z.record(z.string(), z.boolean())));
const GoogleMapsAdditionalOpeningHoursSchema = z.record(z.string(), z.array(GoogleMapsOpeningHoursSchema));
export const GoogleMapsPlaceSchema = z.object({
    ...
    location: GoogleMapsLocationSchema.optional().describe('Geographic coordinates'),
    ...
    reviewsDistribution: GoogleMapsReviewsDistributionSchema.optional().describe('Distribution of reviews by star rating'),
    ...
    additionalOpeningHours: GoogleMapsAdditionalOpeningHoursSchema.optional().describe('Additional opening hours for specific services'),
    peopleAlsoSearch: z
        .array(z.string())
        .optional()
    ...
    additionalInfo: GoogleMapsAdditionalInfoSchema.optional().describe('Additional place attributes and amenities'),
    gasPrices: z
        .array(z.unknown())
        .optional()
