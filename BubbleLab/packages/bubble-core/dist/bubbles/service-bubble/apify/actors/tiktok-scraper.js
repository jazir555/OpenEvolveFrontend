...
export const TikTokScraperInputSchema = z.object({
    ...
    resultsPerPage: z
        ...
        .default(1)
        .optional()
        .describe('Number of videos per hashtag, profile, or search query (default: 1)'),
    profiles: z
        .array(z.string())
        .optional()
        .describe('TikTok usernames to scrape. Examples: ["username1", "username2"]'),
    ...
    profileSorting: z
        ...
        .default('latest')
        .optional()
        .describe('Profile video sorting: latest, popular, or oldest (default: "latest")'),
    ...
    mostDiggs: z
        .number()
        .optional()
        .describe('Popularity filter - scrape videos with hearts less than this number'),
    leastDiggs: z
        .number()
        .optional()
        .describe('Popularity filter - scrape videos with hearts greater than or equal to this number'),
    ...
    searchSection: z
        ...
        .default('')
        .optional()
        .describe('Search section: empty for top, "/video" for videos, "/user" for profiles (default: "")'),
...
export const TikTokVideoSchema = z.object({
    authorMeta: TikTokAuthorMetaSchema.optional().describe('Video author information'),
    collectCount: z
        .number()
        .optional()
    ...
    musicMeta: TikTokMusicMetaSchema.optional().describe('Background music information'),
    playCount: z.number().optional().describe('Number of plays/views'),
    repostCount: z.number().optional().describe('Number of reposts'),
    searchHashtag: TikTokSearchHashtagSchema.optional().describe('Search hashtag information'),
