...
export const TwitterScraperInputSchema = z.object({
    startUrls: z
        .array(z.string())
        .optional()
        .describe('Twitter (X) URLs. Paste the URLs and get the results immediately. Tweet, Profile, Search or List URLs are supported.'),
    searchTerms: z
        .array(z.string())
        .optional()
        .describe('Search terms you want to search from Twitter (X). You can refer to https://github.com/igorbrigadir/twitter-advanced-search.'),
    twitterHandles: z
        .array(z.string())
        .optional()
    ...
    sort: z
        .enum(['Top', 'Latest'])
        .optional()
        .describe('Sorts search results by the given option. Only works with search terms and search URLs.'),
    tweetLanguage: z
        .enum([
        'ab',
        'aa',
        ...
        .optional()
        .describe('Restricts tweets to the given language, given by an ISO 639-1 code.'),
});
