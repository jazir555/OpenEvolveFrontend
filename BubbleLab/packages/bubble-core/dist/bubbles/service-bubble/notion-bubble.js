...
const NotionIdSchema = z.string().refine((id) => /^[a-f0-9]{32}$/.test(id), 'Invalid Notion ID format. Expected 32-character hexadecimal string.');
...
export class NotionBubble extends ServiceBubble {
    ...
    static schema = NotionBubbleParamsSchema;
    static resultSchema = NotionBubbleResultSchema;
    static shortDescription = 'Production-ready Notion integration for pages, databases, and blocks';
  ...
  `;
    ...
    async performAction(context) {
        ...
        try {
            ...
            switch (operation) {
                case 'createPage':
                    result = await this.createPage(this.params);
                    break;
                case 'getPage':
                    result = await this.getPage(this.params);
                    break;
                case 'updatePage':
                    result = await this.updatePage(this.params);
                    break;
                case 'deletePage':
                    result = await this.deletePage(this.params);
                    break;
                case 'queryDatabase':
                    result = await this.queryDatabase(this.params);
                    break;
                case 'createDatabaseEntry':
                    result = await this.createDatabaseEntry(this.params);
                    break;
                case 'updateDatabaseEntry':
                    result = await this.updateDatabaseEntry(this.params);
                    break;
                case 'getDatabase':
                    result = await this.getDatabase(this.params);
                    break;
                case 'appendBlocks':
                    result = await this.appendBlocks(this.params);
                    break;
                case 'getBlocks':
                    result = await this.getBlocks(this.params);
                    break;
                case 'getBlock':
                    result = await this.getBlock(this.params);
                    break;
                case 'updateBlock':
                    result = await this.updateBlock(this.params);
                    break;
                case 'deleteBlock':
                    result = await this.deleteBlock(this.params);
                    break;
                case 'search':
                    result = await this.search(this.params);
                    break;
                case 'searchPages':
                    result = await this.searchPages(this.params);
                    break;
                case 'getDatabaseEntries':
                    result = await this.getDatabaseEntries(this.params);
                    break;
                case 'createDatabase':
                    result = await this.createDatabase(this.params);
                    break;
                default:
    ...
    async getPage(params) {
        ...
        try {
            ...
            return {
                ...
                properties: response.properties,
                children: response.children?.map((child) => child) || [],
                icon: response.icon,
    ...
    // ========================================================================
    async updateDatabaseEntry(params) {
    ...
    // ========================================================================
    async getDatabaseEntries(params) {
...
//# sourceMappingURL=notion-bubble.js.map