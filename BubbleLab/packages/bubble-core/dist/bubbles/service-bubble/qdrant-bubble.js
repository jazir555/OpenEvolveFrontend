...
export class QdrantBubble extends ServiceBubble {
    static service = 'qdrant';
    static authType = 'apikey';
    static bubbleName = 'qdrant';
    static type = 'service';
    static schema = QdrantBubbleParamsSchema;
    static resultSchema = QdrantBubbleResultSchema;
    static shortDescription = 'High-performance vector database for similarity search and AI applications';
...
//# sourceMappingURL=qdrant-bubble.js.map