...
export class CodeFormatterTool extends ToolBubble {
     ...
     */
    static type = 'tool';
    static bubbleName = 'code-formatter-tool';
    static schema = CodeFormatterToolParamsSchema;
    static resultSchema = CodeFormatterToolResultSchema;
    static shortDescription = 'Format and beautify code in multiple programming languages';
  ...
  `;
     ...
     */
    countIndentationChanges(original, formatted) {
     ...
     */
    countWhitespaceRemoved(original, formatted) {
...
//# sourceMappingURL=code-formatter-tool.js.map