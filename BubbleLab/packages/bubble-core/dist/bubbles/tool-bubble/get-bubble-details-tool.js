...
export class GetBubbleDetailsTool extends ToolBubble {
  ...
  `;
    ...
    generateTypeInfo(zodType, includeNestedDescriptions = false) {
        ...
        if (def.typeName === 'ZodString') {
            ...
            if (elementType) {
                const elementTypeInfo = this.generateTypeInfo(elementType, includeNestedDescriptions);
                if (elementTypeInfo) {
            ...
            const innerType = this.generateTypeInfo(def.innerType, includeNestedDescriptions);
            ...
            if (valueType) {
                const valueTypeInfo = this.generateTypeInfo(valueType, includeNestedDescriptions);
                if (valueTypeInfo) {
