...
export class ImageProcessorTool extends ToolBubble {
     ...
     */
    static type = 'tool';
    static bubbleName = 'image-processor-tool';
    static schema = ImageProcessorToolParamsSchema;
    static resultSchema = ImageProcessorToolResultSchema;
    static shortDescription = 'Process images with resize, convert, filter operations';
...
//# sourceMappingURL=image-processor-tool.js.map