...
const LinkedInToolParamsSchema = z.object({
    operation: z
        ...
        .describe('Operation to perform: scrapePosts (profiles), searchPosts (keywords), or scrapeJobs'),
    ...
    keyword: z
        .string()
        .optional()
        .describe('Keyword or phrase to search for (for searchPosts/scrapeJobs). Examples: "AI", "hiring", "Software Engineer"'),
    location: z
        .string()
        .optional()
        .describe('Location for job search (e.g. "San Francisco", "Remote") (scrapeJobs only)'),
    jobType: z
    ...
    dateFilter: z
        ...
        .default('')
        .optional()
        .describe('Filter posts/jobs by date range (searchPosts/scrapeJobs). Options: past-24h, past-week, past-month'),
    // Common fields
    limit: z
        .number()
        .max(1000)
...
export class LinkedInTool extends ToolBubble {
  ...
  `;
    ...
    async handleScrapePosts(params) {
        ...
        }, this.context, 'linkedinPostScraper');
    ...
    async handleSearchPosts(params) {
        ...
        const linkedinPostSearcher = new ApifyBubble({
            ...
            timeout: 180000,
            credentials: params.credentials,
        }, this.context, 'linkedinPostSearcher');
    ...
    async handleScrapeJobs(params) {
        ...
        const jobScraper = new ApifyBubble({
    ...
    transformJobs(items) {
        return items.map((item) => {
            ...
            return {
                ...
                company: item.companyName || item.companyLinkedinUrl || item.companyLogo
                    ? {
