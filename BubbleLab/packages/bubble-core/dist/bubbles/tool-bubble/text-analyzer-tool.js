...
export class TextAnalyzerTool extends ToolBubble {
     ...
     */
    static type = 'tool';
    static bubbleName = 'text-analyzer-tool';
    static schema = TextAnalyzerToolParamsSchema;
    static resultSchema = TextAnalyzerToolResultSchema;
    static shortDescription = 'Analyze text for sentiment, keywords, readability, and more';
...
//# sourceMappingURL=text-analyzer-tool.js.map