...
export class TikTokTool extends ToolBubble {
    static bubbleName = 'tiktok-tool';
    static schema = TikTokToolParamsSchema;
    static resultSchema = TikTokToolResultSchema;
    static shortDescription = 'Scrape TikTok profiles, videos, and hashtags.';
  ...
  `;
    ...
    async performAction() {
        ...
        if (!credentials || !credentials[CredentialType.APIFY_CRED]) {
            return this.createErrorResult('TikTok scraping requires authentication. Please configure APIFY_CRED.');
        }
        try {
...
//# sourceMappingURL=tiktok-tool.js.map