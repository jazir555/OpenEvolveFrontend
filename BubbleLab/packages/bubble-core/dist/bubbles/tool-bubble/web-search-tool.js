...
export class WebSearchTool extends ToolBubble {
    ...
    static resultSchema = WebSearchToolResultSchema;
    static shortDescription = 'Performs web searches using Firecrawl to find current information from the web';
  ...
  `;
    static alias = 'websearch';
    static type = 'tool';
    constructor(params = { query: '' }, context) {
