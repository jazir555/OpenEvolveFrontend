...
export class MonitoringAlertWorkflow extends WorkflowBubble {
    ...
    static bubbleName = 'monitoring-alert-workflow';
    static schema = MonitoringAlertParamsSchema;
    static resultSchema = MonitoringAlertResultSchema;
    static shortDescription = 'System monitoring with intelligent alerting';
  ...
  `;
     ...
     */
    determineSeverity(triggeredMetrics) {
     ...
     */
    async sendNotifications(alertId, severity, triggeredMetrics) {
        const notifications = {};
     ...
     */
    formatSlackMessage(alertId, severity, triggeredMetrics) {
        const emojiMap = {
...
//# sourceMappingURL=monitoring-alert.workflow.js.map