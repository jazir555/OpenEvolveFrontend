import { z } from 'zod';
import type { DatabaseMetadata, CredentialOptions, DependencyGraphNode, BubbleOperationResult, BubbleResult } from '@bubblelab/shared-schemas';
...
export interface IServiceBubble<TParams extends Record<string, unknown> = Record<string, unknown>, TResult extends BubbleOperationResult = BubbleOperationResult> extends IBubble<TResult> {
