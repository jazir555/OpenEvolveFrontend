 ...
 */
export function generationsToMessageContent(generations) {
...
export function formatFinalResponse(response, modelName, jsonMode) {
    const finalResponse = typeof response === 'string' ? response : JSON.stringify(response);
