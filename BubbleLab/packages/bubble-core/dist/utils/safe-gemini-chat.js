    ...
    async _generate(messages, options, runManager) {
        try {
            ...
            if (errorMessage.includes('candidateContent') ||
                ...
                console.error('[SafeGeminiChat] Gemini returned blocked/empty content:', errorMessage);
 ...
 */
export function isGeminiErrorResponse(message) {
    ...
    return (contentStr.includes('[Gemini Error]') ||
 ...
 */
export function getGeminiErrorDetails(message) {
    return message.additional_kwargs?.error;
}
//# sourceMappingURL=safe-gemini-chat.js.map