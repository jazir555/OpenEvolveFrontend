...
export class AceToolsBubble extends ServiceBubble<AceToolsBubbleParams, AceToolsBubbleResult> {
  static readonly service = 'ace-tools';
  static readonly authType = 'apikey' as const;
  static readonly bubbleName: BubbleName = 'ace-tools';
  static readonly type = 'service' as const;
  static readonly schema = AceToolsBubbleParamsSchema;
  static readonly resultSchema = AceToolsBubbleResultSchema;
  static readonly shortDescription =
    'Advanced code execution, analysis, and transformation tools';
  ...
  protected async performAction(context?: BubbleContext): Promise<AceToolsBubbleResult> {
    void context;
  ...
  private async executeCode(): Promise<any> {
    const params = this.params as z.output<typeof ExecuteCodeParamsSchema>;
  ...
  private createSandbox(language: string, inputs?: Record<string, any>): any {
    ...
    const sandbox = {
      ...
      console: {
        ...
        error: (...args: any[]) => args.map(arg => String(arg)).join(' '),
        warn: (...args: any[]) => args.map(arg => String(arg)).join(' '),
      },
      Math,
      Date,
      JSON,
  ...
  private async validateCode(): Promise<any> {
    const params = this.params as z.output<typeof ValidateCodeParamsSchema>;
  ...
  private async formatCode(): Promise<any> {
    const params = this.params as z.output<typeof FormatCodeParamsSchema>;
  ...
  private async analyzeCode(): Promise<any> {
    const params = this.params as z.output<typeof AnalyzeCodeParamsSchema>;
  ...
  private async documentCode(): Promise<any> {
    const params = this.params as z.output<typeof DocumentCodeParamsSchema>;
  ...
  private async transformCode(): Promise<any> {
    const params = this.params as z.output<typeof TransformCodeParamsSchema>;
  ...
  private async optimizeCode(): Promise<any> {
    const params = this.params as z.output<typeof OptimizeCodeParamsSchema>;
  ...
  private async reviewCode(): Promise<any> {
    const params = this.params as z.output<typeof ReviewCodeParamsSchema>;
