...
export class GithubBubble extends ServiceBubble<GithubBubbleParams, GithubBubbleResult> {
  static readonly service = 'github';
  static readonly authType = 'token' as const;
  static readonly bubbleName: BubbleName = 'github';
  static readonly type = 'service' as const;
  static readonly schema = GithubBubbleParamsSchema;
  static readonly resultSchema = GithubBubbleResultSchema;
  ...
  protected async performAction(context?: BubbleContext): Promise<GithubBubbleResult> {
    void context;
  ...
  private async createIssue(): Promise<any> {
    const params = this.params as z.output<typeof CreateIssueParamsSchema>;
  ...
  private async updateIssue(): Promise<any> {
    const params = this.params as z.output<typeof UpdateIssueParamsSchema>;
  ...
  private async listIssues(): Promise<any> {
    const params = this.params as z.output<typeof ListIssuesParamsSchema>;
    ...
    const result = await this.makeRequest(
      'GET',
      `/repos/${params.owner}/${params.repo}/issues?${queryParams.toString()}`
    );
  ...
  private async createPullRequest(): Promise<any> {
    const params = this.params as z.output<typeof CreatePullRequestParamsSchema>;
  ...
  private async mergePullRequest(): Promise<any> {
    const params = this.params as z.output<typeof MergePullRequestParamsSchema>;
  ...
  private async listPullRequests(): Promise<any> {
    const params = this.params as z.output<typeof ListPullRequestsParamsSchema>;
  ...
  private async createBranch(): Promise<any> {
    const params = this.params as z.output<typeof CreateBranchParamsSchema>;

    // First, get the SHA of the base branch
    const baseBranch = await this.makeRequest(
      'GET',
      `/repos/${params.owner}/${params.repo}/git/refs/heads/${params.fromBranch}`
    );
  ...
  private async deleteBranch(): Promise<any> {
    const params = this.params as z.output<typeof DeleteBranchParamsSchema>;

    await this.makeRequest(
      'DELETE',
      `/repos/${params.owner}/${params.repo}/git/refs/heads/${params.branchName}`
    );
  ...
  private async getRepository(): Promise<any> {
    const params = this.params as z.output<typeof GetRepositoryParamsSchema>;
  ...
  private async createCommit(): Promise<any> {
    const params = this.params as z.output<typeof CreateCommitParamsSchema>;
  ...
  private extractRepo(): string | undefined {
    const params = this.params as any;
    return params.repo;
  }

  private extractOwner(): string | undefined {
    const params = this.params as any;
    return params.owner;
  }
}
