{
  /*
   * Comprehensive Test Suite for text-analyzer-tool
   * Generated: 2026-01-19T02:05:45.152523
   *
  ...
  describe('text-analyzer-tool', () => {
    ...
    beforeEach(() => {
      ...
      // Initialize instance
      instance = new TextAnalyzerTool(mockContext);
    });
    ...
    describe('Environment Validation', () => {
      it('should validate required environment variables', async () => {
        ...
        // Act & Assert
        await expect(
          new TextAnalyzerTool({ env: invalidEnv })
      ...
      it('should fail fast on critical missing vars', async () => {
        ...
        // Act & Assert
        await expect(
          new TextAnalyzerTool({ env: criticalEnv })
      ...
      it('should accept valid environment configuration', async () => {
        ...
        // Act & Assert
        const validInstance = new TextAnalyzerTool({ env: validEnv });
