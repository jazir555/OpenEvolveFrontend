{
  /*
   * Comprehensive Test Suite for web-crawl-tool
  ...
  describe('web-crawl-tool', () => {
    ...
    beforeEach(() => {
      ...
      // Initialize instance
      instance = new WebCrawlTool(mockContext);
    });
    ...
    describe('Environment Validation', () => {
      it('should validate required environment variables', async () => {
        ...
        // Act & Assert
        await expect(
          new WebCrawlTool({ env: invalidEnv })
      ...
      it('should fail fast on critical missing vars', async () => {
        ...
        // Act & Assert
        await expect(
          new WebCrawlTool({ env: criticalEnv })
      ...
      it('should accept valid environment configuration', async () => {
        ...
        // Act & Assert
        const validInstance = new WebCrawlTool({ env: validEnv });
