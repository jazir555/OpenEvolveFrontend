{
  /*
   * Comprehensive Test Suite for youtube-tool
  ...
  describe('youtube-tool', () => {
    ...
    beforeEach(() => {
      ...
      // Initialize instance
      instance = new YouTubeTool(mockContext);
    });
    ...
    describe('Environment Validation', () => {
      it('should validate required environment variables', async () => {
        ...
        // Act & Assert
        await expect(
          new YouTubeTool({ env: invalidEnv })
      ...
      it('should fail fast on critical missing vars', async () => {
        ...
        // Act & Assert
        await expect(
          new YouTubeTool({ env: criticalEnv })
      ...
      it('should accept valid environment configuration', async () => {
        ...
        // Act & Assert
        const validInstance = new YouTubeTool({ env: validEnv });
