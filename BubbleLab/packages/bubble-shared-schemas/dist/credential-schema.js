...
export const CREDENTIAL_ENV_MAP = {
    ...
    [CredentialType.STRIPE_CRED]: 'STRIPE_API_KEY',
    [CredentialType.SENDGRID_CRED]: 'SENDGRID_API_KEY',
    [CredentialType.TWILIO_CRED]: 'TWILIO_API_KEY',
...
export const BUBBLE_CREDENTIAL_OPTIONS = {
    ...
    postgresql: [CredentialType.POSTGRESQL_CRED],
    ...
    'ace-tools': [],
    elasticsearch: [CredentialType.ELASTICSEARCH_CRED],
    qdrant: [CredentialType.QDRANT_CRED],
    redis: [CredentialType.REDIS_CRED],
...
export const createCredentialSchema = z
    ...
    isDefault: z.boolean().optional().openapi({
        description: 'Set this credential as the default for its credential type. Only one credential per type can be default.',
        example: false,
    }),
...
export const credentialResponseSchema = z
    ...
    isDefault: z
        .boolean()
        .optional()
        .openapi({ description: 'Whether this is the default credential for its type' }),
