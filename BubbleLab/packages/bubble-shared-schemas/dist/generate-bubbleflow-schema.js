...
export const bubbleFlowTemplateResponseSchema = z
    ...
    // Flow decomposition metadata
    flowDecomposition: z
        .object({
        displayedParameters: z.array(z.object({
            name: z.string(),
            ...
            source: z.enum(['literal', 'reference', 'environment', 'computed']),
        })),
        dependencies: z.object({
            nodes: z.array(z.object({
                id: z.string(),
                type: z.enum(['bubble', 'parameter', 'trigger']),
                label: z.string(),
            })),
            edges: z.array(z.object({
                from: z.string(),
                to: z.string(),
                type: z.enum(['data', 'control', 'resource']),
                description: z.string().optional(),
            })),
        }),
        ...
        metadata: z.object({
            ...
            configurableParameters: z.number(),
            environmentParameters: z.number(),
            nestedParameterCount: z.number(),
            conditionalParameterCount: z.number(),
        ...
        .optional()
        .openapi({
        description: 'Enhanced flow decomposition with dependency analysis and parameter metadata',
    }),
    bubbleParameters: z
