/**
 * Tests for Log Aggregation Analyzer
 * Tests log aggregation and analysis
 */

import { describe, it, expect, vi, beforeEach, afterEach } from 'vitest';

describe('LogAggregationAnalyzer', () => {
  let workflow: any;
  ...
  beforeEach(() => {
    ...
    process.env.ELASTICSEARCH_URL = 'test_elasticsearch_url_value';
  ...
  describe('Environment Validation', () => {
    it('should validate required environment variables', () => {
      expect(process.env.ELASTICSEARCH_URL).toBeDefined();
    ...
    it('should fail fast on critical missing vars', () => {
      const required = 'ELASTICSEARCH_URL', 'API_KEY';
