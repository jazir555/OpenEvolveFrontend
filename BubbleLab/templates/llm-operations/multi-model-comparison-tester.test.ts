/**
 * Tests for Multi Model Comparison Tester
 * Tests comparison across multiple models
 */

import { describe, it, expect, vi, beforeEach, afterEach } from 'vitest';

describe('MultiModelComparisonTester', () => {
  let workflow: any;
  ...
  beforeEach(() => {
    ...
    process.env.ANTHROPIC_API_KEY = 'test_anthropic_api_key_value';
  ...
  describe('Environment Validation', () => {
    ...
    it('should fail fast on critical missing vars', () => {
      const required = 'OPENAI_API_KEY', 'ANTHROPIC_API_KEY', 'API_KEY';
