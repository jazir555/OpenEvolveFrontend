...
EXTRACTION_PROMPT = """
TASK: PoDataExtraction

EXTRACTION TASK:
Extracting information from purchase orders and bill of materials
...
OUTPUT FORMAT:
Return the extracted information as a JSON object that exactly matches the PodataextractionInfo structure shown above.
