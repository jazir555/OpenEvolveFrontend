 ...
 */
export type NodeStatus = 'idle' | 'running' | 'completed' | 'failed' | 'paused' | 'cancelled';
/**
 ...
 *
 * TODO: Implement SubProblemNode class
 */
 ...
 *
 * TODO: Implement GauntletNode class
 */
 ...
 *
 * TODO: Implement AssemblyNode class
 */
 ...
 *
 * TODO: Implement OutputNode class
 */
 ...
 *
 * TODO: Implement KnowledgeExtractionNode class
 */
 ...
 * Sub-problem status
 */
export type SubProblemStatus = 'pending' | 'in_progress' | 'completed' | 'failed' | 'blocked' | 'cancelled';
/**
 ...
 * Parameter type
 */
export type ParameterType = 'string' | 'number' | 'boolean' | 'object' | 'array' | 'enum' | 'any';
/**
 ...
 */
export type SolutionMethod = 'evolutionary' | 'analytical' | 'heuristic' | 'neural' | 'hybrid';
/**
 ...
 */
export declare function isOpenEvolveNode(value: unknown): value is OpenEvolveNode;
/**
 * Type guard for NodeResult
 */
export declare function isNodeResult(value: unknown): value is NodeResult;
/**
 * Type guard for NodeError
 */
export declare function isNodeError(value: unknown): value is NodeError;
/**
