...
- `streamlit_autorefresh` - Auto-refresh capability
- `streamlit_tags` - Tag input widgets
...
- `streamlit_autorefresh` - Auto-refresh
...
## File: `LeanAide/server/streamlit_ui.py`
...
- LeanAide/streamlit_ui.py - Multi-page app
...
├── LeanAide/
│   └── server/
│       ├── streamlit_ui.py         [MEDIUM] - LeanAide main UI
│       └── tabs/
