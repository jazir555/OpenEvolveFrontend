...
class CollaborationManager:
    ...
    def apply_edit_operation(self, session_id: str, user_id: str, operation: Dict) -> Dict:
        """
    ...
    def resolve_conflict(self, session_id: str, conflict_id: str, resolution: str) -> bool:
        """
    ...
    def add_notification(self, message: str, sender: str = "System", notification_type: str = "info") -> str:
        """
    ...
    def get_unread_notifications(self) -> List[Dict]:
        ...
        with st.session_state.thread_lock:
            ...
            if "notifications" not in st.session_state.collaboration_session:
                st.session_state.collaboration_session["notifications"] = []
            return [n for n in st.session_state.collaboration_session["notifications"] if not n.get("read")]
    ...
    def add_collaborator(self, user_email: str, role: str = "viewer") -> bool:
        ...
        try:
            ...
            # Add notification
            self.add_notification(f"New collaborator added: {user_email}", "System", "info")
            return True
    ...
    def remove_collaborator(self, user_email: str) -> bool:
        ...
        try:
            with st.session_state.thread_lock:
                ...
                st.session_state.collaborators = [
                    c for c in st.session_state.collaborators 
                    if c["email"] != user_email
                ]
            
            # Add notification
            self.add_notification(f"Collaborator removed: {user_email}", "System", "info")
            return True
        except Exception as e:
