...
class ContentManagement:
    ...
    def export_protocol_as_template(self, protocol_text: str, template_name: str) -> Dict:
        """
    ...
    def validate_protocol(self, protocol_text: str, validation_type: str = "generic") -> Dict:
        """
        ...
        rules = self.validation_rules.get(validation_type, self.validation_rules.get("generic", {}))
    ...
    def render_validation_results(self, protocol_text: str, validation_type: str = "generic") -> str:
        """
