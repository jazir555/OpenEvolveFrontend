...
export const {
  ...
  evolutionAssets,
  idempotencyKeys,
  evolutionRequestsRelations,
  evolutionDesignsRelations,
  evolutionJudgeScoresRelations,
  evolutionResultsRelations,
  evolutionScreenshotsRelations,
  evolutionRunsRelations,
  evolutionNodesRelations,
  evolutionAssetsRelations,
} = schema;
