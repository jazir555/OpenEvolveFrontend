#!/bin/bash
# twilio.probe.sh - Runtime Validation Probe for twilio
#
# Comprehensive probe script to validate twilio service health and functionality
# Tests connectivity, endpoints, performance, and error handling
#
# Usage: ./probes/twilio.probe.sh
...
# Test 2.$((i + 1)): /2010-04-01/Accounts
if [[ "/2010-04-01/Accounts" == "/"* ]]; then
    test_json_endpoint "/2010-04-01/Accounts" "Endpoint 1: /2010-04-01/Accounts" || \
    test_http_endpoint "/2010-04-01/Accounts" "Endpoint 1: /2010-04-01/Accounts" "200" || \
    log_warning "Endpoint 1 (/2010-04-01/Accounts) not available"
else
    log_info "Command check: /2010-04-01/Accounts"
    # For non-HTTP endpoints (Redis commands, SQL queries, etc.)
    log_success "PASS (Command defined)"
    ((PASS_COUNT++))
fi

# Test 2.$((i + 1)): /2010-04-01/Accounts.json
if [[ "/2010-04-01/Accounts.json" == "/"* ]]; then
    test_json_endpoint "/2010-04-01/Accounts.json" "Endpoint 2: /2010-04-01/Accounts.json" || \
    test_http_endpoint "/2010-04-01/Accounts.json" "Endpoint 2: /2010-04-01/Accounts.json" "200" || \
    log_warning "Endpoint 2 (/2010-04-01/Accounts.json) not available"
else
    log_info "Command check: /2010-04-01/Accounts.json"
    # For non-HTTP endpoints (Redis commands, SQL queries, etc.)
    log_success "PASS (Command defined)"
    ((PASS_COUNT++))
fi

# Test 2.$((i + 1)): /2010-04-01/Accounts.json/Calls.json
if [[ "/2010-04-01/Accounts.json/Calls.json" == "/"* ]]; then
    test_json_endpoint "/2010-04-01/Accounts.json/Calls.json" "Endpoint 3: /2010-04-01/Accounts.json/Calls.json" || \
    test_http_endpoint "/2010-04-01/Accounts.json/Calls.json" "Endpoint 3: /2010-04-01/Accounts.json/Calls.json" "200" || \
    log_warning "Endpoint 3 (/2010-04-01/Accounts.json/Calls.json) not available"
else
    log_info "Command check: /2010-04-01/Accounts.json/Calls.json"
    # For non-HTTP endpoints (Redis commands, SQL queries, etc.)
    log_success "PASS (Command defined)"
    ((PASS_COUNT++))
fi

# Test 2.$((i + 1)): /2010-04-01/Accounts.json/Messages.json
if [[ "/2010-04-01/Accounts.json/Messages.json" == "/"* ]]; then
    test_json_endpoint "/2010-04-01/Accounts.json/Messages.json" "Endpoint 4: /2010-04-01/Accounts.json/Messages.json" || \
    test_http_endpoint "/2010-04-01/Accounts.json/Messages.json" "Endpoint 4: /2010-04-01/Accounts.json/Messages.json" "200" || \
    log_warning "Endpoint 4 (/2010-04-01/Accounts.json/Messages.json) not available"
else
    log_info "Command check: /2010-04-01/Accounts.json/Messages.json"
    # For non-HTTP endpoints (Redis commands, SQL queries, etc.)
    log_success "PASS (Command defined)"
    ((PASS_COUNT++))
fi
...
if [ ${FAIL_COUNT} -eq 0 ]; then
    echo -e "${GREEN}✅ TWILIO PROBE PASSED${NC}"
    echo ""
    exit 0
else
    echo -e "${RED}❌ TWILIO PROBE FAILED${NC}"
    echo ""
    exit 1
fi
