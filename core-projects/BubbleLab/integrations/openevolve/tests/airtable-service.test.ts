/**
 * AirtableBubble Test Suite
 *
 * Comprehensive tests for airtable service bubble
 *
 * Test Coverage:
...
import { AirtableBubble } from '../service-bubbles/airtable-bubble';
...
describe('AirtableBubble', () => {
  ...
  describe('1. Base Class Inheritance', () => {
    it('should extend ServiceBubble properly', () => {
      ...
      expect(bubble.constructor.name).toBe('AirtableBubble');
      expect(typeof bubble.action).toBe('function');
    });

    it('should have correct static properties', () => {
      expect(AirtableBubble.service).toBe('openevolve');
  ...
  describe('7. Request Deduplication', () => {
    ...
    it('should not deduplicate different requests', async () => {
      const bubble1 = new AirtableBubble({
        operation: 'test1',
        baseId: 'appBase123'
      } as any);

      const bubble2 = new AirtableBubble({
        operation: 'test2',
        baseId: 'appBase123'
      } as any);
