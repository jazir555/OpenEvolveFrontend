/**
 * TextAnalyzerTool Test Suite
 *
 * Comprehensive tests for text-analyzer tool bubble
 *
 * Test Coverage:
...
import { TextAnalyzerTool } from '../tool-bubbles/text-analyzer-tool';
...
describe('TextAnalyzerTool', () => {
  ...
  describe('1. Base Class Inheritance', () => {
    it('should extend ToolBubble properly', () => {
      const bubble = new TextAnalyzerTool({
        operation: 'test',
        text: 'test'
      } as any);

      expect(bubble).toBeDefined();
      expect(bubble.constructor.name).toBe('TextAnalyzerTool');
      expect(typeof bubble.action).toBe('function');
    });

    it('should have correct static properties', () => {
      expect(TextAnalyzerTool.service).toBe('openevolve');
      expect(TextAnalyzerTool.bubbleName).toBe('text-analyzer');
      expect(TextAnalyzerTool.type).toBe('tool');
    });
  ...
  describe('7. Request Deduplication', () => {
    ...
    it('should not deduplicate different requests', async () => {
      const bubble1 = new TextAnalyzerTool({
        operation: 'test1',
        text: 'test'
      } as any);

      const bubble2 = new TextAnalyzerTool({
        operation: 'test2',
        text: 'test'
      } as any);
