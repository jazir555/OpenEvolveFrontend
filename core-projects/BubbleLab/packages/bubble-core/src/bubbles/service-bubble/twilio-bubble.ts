...
export class TwilioBubble extends ServiceBubble<TwilioBubbleParams, TwilioBubbleResult> {
  static readonly service = 'twilio';
  static readonly authType = 'apikey' as const;
  static readonly bubbleName: BubbleName = 'twilio';
  static readonly type = 'service' as const;
  static readonly schema = TwilioBubbleParamsSchema;
  static readonly resultSchema = TwilioBubbleResultSchema;
  static readonly shortDescription =
    'SMS, voice, and WhatsApp messaging platform';
  ...
  protected async performAction(context?: BubbleContext): Promise<TwilioBubbleResult> {
    void context;
  ...
  private async sendSMS(client: ReturnType<typeof twilio>): Promise<any> {
    const params = this.params as z.output<typeof SendSMSParamsSchema>;
  ...
  private async makeCall(client: ReturnType<typeof twilio>): Promise<any> {
    const params = this.params as z.output<typeof MakeCallParamsSchema>;
  ...
  private async sendWhatsApp(client: ReturnType<typeof twilio>): Promise<any> {
    const params = this.params as z.output<typeof SendWhatsAppParamsSchema>;
  ...
  private async lookupNumber(client: ReturnType<typeof twilio>): Promise<any> {
    const params = this.params as z.output<typeof LookupNumberParamsSchema>;
    ...
    return {
      ...
      carrier: (lookups as any).carrier,
      type: params.type,
    };
  }

  private async createMessage(client: ReturnType<typeof twilio>): Promise<any> {
    const params = this.params as z.output<typeof CreateMessageParamsSchema>;
  ...
  private async getMessage(client: ReturnType<typeof twilio>): Promise<any> {
    const params = this.params as z.output<typeof GetMessageParamsSchema>;
  ...
  private async getMedia(client: ReturnType<typeof twilio>): Promise<any> {
    const params = this.params as z.output<typeof GetMediaParamsSchema>;
  ...
  private async validateNumber(client: ReturnType<typeof twilio>): Promise<any> {
    const params = this.params as z.output<typeof ValidateNumberParamsSchema>;
