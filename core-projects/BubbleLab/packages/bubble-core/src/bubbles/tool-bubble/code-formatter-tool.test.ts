{
  /*
   * Comprehensive Test Suite for code-formatter-tool
  ...
  describe('code-formatter-tool', () => {
    let instance: CodeFormatterTool;
    let mockContext: any;
    ...
    beforeEach(() => {
      ...
      // Initialize instance
      instance = new CodeFormatterTool(mockContext);
    });
    ...
    describe('Environment Validation', () => {
      it('should validate required environment variables', async () => {
        ...
        // Act & Assert
        await expect(
          new CodeFormatterTool({ env: invalidEnv })
      ...
      it('should fail fast on critical missing vars', async () => {
        ...
        // Act & Assert
        await expect(
          new CodeFormatterTool({ env: criticalEnv })
      ...
      it('should accept valid environment configuration', async () => {
        ...
        // Act & Assert
        const validInstance = new CodeFormatterTool({ env: validEnv });
