{
  ...
  describe('json-validator-tool', () => {
    ...
    beforeEach(() => {
      ...
      // Initialize instance
      instance = new JSONValidatorTool(mockContext);
    });
    ...
    describe('Environment Validation', () => {
      it('should validate required environment variables', async () => {
        ...
        // Act & Assert
        await expect(
          new JSONValidatorTool({ env: invalidEnv })
      ...
      it('should fail fast on critical missing vars', async () => {
        ...
        // Act & Assert
        await expect(
          new JSONValidatorTool({ env: criticalEnv })
      ...
      it('should accept valid environment configuration', async () => {
        ...
        // Act & Assert
        const validInstance = new JSONValidatorTool({ env: validEnv });
