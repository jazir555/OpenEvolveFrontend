{
  /*
   * Comprehensive Test Suite for tool-template
  ...
  describe('tool-template', () => {
    ...
    beforeEach(() => {
      ...
      // Initialize instance
      instance = new MyCustomTool(mockContext);
    });
    ...
    describe('Environment Validation', () => {
      it('should validate required environment variables', async () => {
        ...
        // Act & Assert
        await expect(
          new MyCustomTool({ env: invalidEnv })
      ...
      it('should fail fast on critical missing vars', async () => {
        ...
        // Act & Assert
        await expect(
          new MyCustomTool({ env: criticalEnv })
      ...
      it('should accept valid environment configuration', async () => {
        ...
        // Act & Assert
        const validInstance = new MyCustomTool({ env: validEnv });
