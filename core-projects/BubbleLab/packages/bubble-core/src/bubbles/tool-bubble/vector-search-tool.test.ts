{
  ...
  describe('vector-search-tool', () => {
    ...
    beforeEach(() => {
      ...
      // Initialize instance
      instance = new VectorSearchTool(mockContext);
    });
    ...
    describe('Environment Validation', () => {
      it('should validate required environment variables', async () => {
        ...
        // Act & Assert
        await expect(
          new VectorSearchTool({ env: invalidEnv })
      ...
      it('should fail fast on critical missing vars', async () => {
        ...
        // Act & Assert
        await expect(
          new VectorSearchTool({ env: criticalEnv })
      ...
      it('should accept valid environment configuration', async () => {
        ...
        // Act & Assert
        const validInstance = new VectorSearchTool({ env: validEnv });
