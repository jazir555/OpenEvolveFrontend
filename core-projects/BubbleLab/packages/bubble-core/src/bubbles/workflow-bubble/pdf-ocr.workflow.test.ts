{
  /*
   * Comprehensive Test Suite for pdf-ocr.workflow
  ...
  describe('pdf-ocr.workflow', () => {
    ...
    beforeEach(() => {
      ...
      // Initialize instance
      instance = new PDFOcrWorkflow(mockContext);
    });
    ...
    describe('Environment Validation', () => {
      it('should validate required environment variables', async () => {
        ...
        // Act & Assert
        await expect(
          new PDFOcrWorkflow({ env: invalidEnv })
      ...
      it('should fail fast on critical missing vars', async () => {
        ...
        // Act & Assert
        await expect(
          new PDFOcrWorkflow({ env: criticalEnv })
      ...
      it('should accept valid environment configuration', async () => {
        ...
        // Act & Assert
        const validInstance = new PDFOcrWorkflow({ env: validEnv });
