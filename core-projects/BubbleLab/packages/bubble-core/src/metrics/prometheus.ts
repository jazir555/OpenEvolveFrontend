...
export const bubbleOperationDuration = new Histogram({
  ...
  labelNames: ['bubble', 'operation', 'status'] as const,
...
export const bubbleOperationRetryTotal = new Counter({
  ...
  labelNames: ['bubble', 'operation'] as const,
  registers: [register]
});
...
export const circuitBreakerState = new Gauge({
  ...
  labelNames: ['bubble', 'state'] as const,
  registers: [register]
});
...
export const bubbleErrorTotal = new Counter({
  ...
  labelNames: ['bubble', 'error_type', 'operation'] as const,
  registers: [register]
});
...
export const bubbleValidationErrorTotal = new Counter({
  ...
  labelNames: ['bubble', 'validation_error_type'] as const,
  registers: [register]
});
...
export const dbConnectionPoolUsage = new Gauge({
  ...
  labelNames: ['bubble', 'pool_type'] as const,
  registers: [register]
});
 ...
 */
export function resetMetric(metric: Counter | Histogram | Gauge): void {
  metric.reset();
}
 ...
 */
export function trackOperation(bubbleName: string, operationName: string) {
  return function (
    target: unknown,
    propertyKey: string,
    ...
    descriptor.value = async function (...args: unknown[]) {
      ...
      try {
        ...
        bubbleOperationDuration.observe(
          { bubble: bubbleName, operation: operationName, status },
          duration
        );
 ...
 */
export function recordCircuitBreakerFailure(bubbleName: string): void {
 ...
 */
export function recordCircuitBreakerSuccess(bubbleName: string): void {
