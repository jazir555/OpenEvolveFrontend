...
export type BubbleName =
  ...
  | 'crewai-research'
  | 'openevolve-decomposition-plan-get'
  | 'openevolve-decomposition-plan-update'
  | 'openevolve-decomposition-execute'
  | 'openevolve-decomposition-execution-status'
  | 'openevolve-decomposition-settings'
  | 'openevolve-decomposition-results'
  | 'openevolve-decomposition-telemetry'
  | 'openevolve-decomposition-truth-package'
  | 'openevolve-decomposition-resource-usage'
  | 'openevolve-gauntlet-execute'
  | 'openevolve-gauntlet-execution-status'
  | 'openevolve-gauntlet-executions-list'
  | 'openevolve-adversarial-run'
  | 'openevolve-evolution-run'
  | 'openevolve-knowledge-graph'
  | 'openevolve-knowledge-stats'
  | 'openevolve-knowledge-recommendations'
  | 'openevolve-knowledge-export'
  | 'openevolve-knowledge-import'
  | 'openevolve-knowledge-get'
  | 'openevolve-knowledge-delete'
  | 'openevolve-knowledge-documents'
  | 'openevolve-knowledge-embed'
  | 'openevolve-knowledge-sync'
  | 'openevolve-monitoring-dashboard'
  | 'openevolve-monitoring-alerts'
  | 'openevolve-monitoring-services'
  | 'openevolve-monitoring-logs'
  | 'openevolve-monitoring-metrics'
  | 'openevolve-monitoring-health'
  | 'openevolve-analytics-statistics'
  | 'openevolve-analytics-performance'
  | 'openevolve-analytics-knowledge'
  | 'openevolve-analytics-workflow'
  | 'openevolve-settings-icr'
  | 'openevolve-settings-determinism'
  | 'openevolve-settings-adaptive-decomposition'
  | 'openevolve-settings-mdap-maker'
  | 'openevolve-settings-roma-mdap-maker'
  | 'openevolve-decomposition-to-evolution'
  | 'openevolve-gauntlet-red-blue-gold'
  | 'openevolve-adversarial-to-evolution'
  | 'openevolve-full-evolution-lifecycle'
  | 'openevolve-workflow-decomposition-pipeline'
  | 'openevolve-verified-deployment'
  | 'openevolve-team-members'
  | 'openevolve-team-assign'
  | 'openevolve-team-templates'
  | 'openevolve-team-llms'
  | 'openevolve-team-credentials'
  | 'openevolve-version-control'
  | 'openevolve-validation'
  | 'openevolve-parameters'
  | 'openevolve-providers'
  | 'openevolve-audit-logs'
  | 'openevolve-auto-approval'
  | 'openevolve-prompts'
  | 'openevolve-content-templates'
  | 'openevolve-content-validate'
  | 'openevolve-security'
  | 'openevolve-gateway'
  | 'openevolve-v1-evolve'
  | 'openevolve-v1-runs'
  | 'openevolve-v1-workflow-lifecycle'
  | 'openevolve-integrated-run'
  | 'openevolve-orchestration-models'
  | 'openevolve-orchestration-ensemble'
  | 'bubblelabs-status'
  | 'bubblelabs-init'
  ...
  | 'icr-config'
  | 'icr-dashboard'
  | 'adaptive-mdap-dashboard'
  | 'adaptive-mdap-profiles'
  | 'adaptive-mdap-cost'
  ...
  | 'maker-execute'
  | 'maker-delegations'
  | 'maker-delegations-sync'
  | 'knowledge-explorer-status'
  | 'knowledge-explorer-query'
  | 'knowledge-explorer-history'
  | 'knowledge-explorer-extract'
  | 'knowledge-explorer-extract-file'
  | 'suggestions-content'
