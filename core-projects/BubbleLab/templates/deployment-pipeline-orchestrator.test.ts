/**
 * Tests for Deployment Pipeline Orchestrator
 * Tests pipeline execution, stage sequencing, and rollback logic
 */

import { describe, it, expect, vi, beforeEach, afterEach } from 'vitest';

describe('DeploymentPipelineOrchestrator', () => {
  let workflow: any;
  ...
  describe('Environment Validation', () => {
    ...
    it('should fail fast on critical missing vars', () => {
      const required = 'GITHUB_PAT', 'API_KEY', 'KUBE_CONFIG';
