/**
 * Tests for Distributed Tracing Analyzer
 * Tests distributed tracing and performance analysis
 */

import { describe, it, expect, vi, beforeEach, afterEach } from 'vitest';

describe('DistributedTracingAnalyzer', () => {
  let workflow: any;
  ...
  beforeEach(() => {
    ...
    process.env.JAEGER_URL = 'test_jaeger_url_value';
  ...
  describe('Environment Validation', () => {
    it('should validate required environment variables', () => {
      expect(process.env.JAEGER_URL).toBeDefined();
    ...
    it('should fail fast on critical missing vars', () => {
      const required = 'JAEGER_URL', 'API_KEY';
