/**
 * Tests for Model Performance Benchmark
 * Tests benchmark execution, metric collection, and comparison logic
 */

import { describe, it, expect, vi, beforeEach, afterEach } from 'vitest';

describe('ModelPerformanceBenchmark', () => {
  let workflow: any;
  ...
  describe('Environment Validation', () => {
    ...
    it('should fail fast on critical missing vars', () => {
      const required = 'OPENAI_API_KEY', 'API_KEY', 'POSTGRES_CONNECTION_STRING';
