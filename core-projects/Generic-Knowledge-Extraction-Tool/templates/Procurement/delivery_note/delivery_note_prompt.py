...
EXTRACTION_PROMPT = """
TASK: Procurement - Delivery_Note Extraction

EXTRACTION TASK:
Extract delivery_note information from delivery_note documents
...
OUTPUT FORMAT:
Return the extracted information as a JSON object that exactly matches the ProcurementDeliveryNoteinfo structure shown above.
