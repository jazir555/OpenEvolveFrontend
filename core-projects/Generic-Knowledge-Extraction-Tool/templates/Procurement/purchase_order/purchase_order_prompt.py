...
EXTRACTION_PROMPT = """
TASK: Procurement - Purchase_Order Extraction

EXTRACTION TASK:
Extract purchase_order information from purchase_order documents
...
OUTPUT FORMAT:
Return the extracted information as a JSON object that exactly matches the ProcurementPurchaseOrderinfo structure shown above.
