...
sealed class BroadcastMessage {
  ...
  factory BroadcastMessage.fromJson(Map<String, dynamic> json) {
    ...
    switch (type) {
      ...
      case 'FailureSpotlight':
        return FailureSpotlight(payload);
      case 'EntanglementUpdate':
        return EntanglementUpdate(payload);
      case 'IndexerStatus':
...
class FailureSpotlight extends BroadcastMessage {
  final String nodeId;
  final String reason;
  final String severity;

  FailureSpotlight(Map<String, dynamic> json)
      : nodeId = json['node_id'] as String,
        reason = json['reason'] as String? ?? '',
        severity = json['severity'] as String? ?? 'error',
        super('FailureSpotlight');
}

class EntanglementUpdate extends BroadcastMessage {
  final List<String> nodeIds;
  final String? sourceId;

  EntanglementUpdate(Map<String, dynamic> json)
      : nodeIds = (json['node_ids'] as List?)?.cast<String>() ?? const [],
        sourceId = json['source_id'] as String?,
        super('EntanglementUpdate');
}
