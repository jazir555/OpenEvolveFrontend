...
class GraphState {
  ...
  final List<String> entangledNodeIds;
  ...
  GraphState copyWith({
    ...
    return GraphState(
      ...
      failureNodeId: failureNodeId ?? this.failureNodeId,
      entangledNodeIds: entangledNodeIds ?? this.entangledNodeIds,
...
class GraphNotifier extends StateNotifier<GraphState> {
  ...
  void _handleMessage(BroadcastMessage message) {
    ...
    } else if (message is FailureSpotlight) {
      state = state.copyWith(
        failureNodeId: message.nodeId,
        selectedNodeId: message.nodeId,
        spotlightNodeId: message.nodeId,
      );
    } else if (message is EntanglementUpdate) {
      state = state.copyWith(
        entangledNodeIds: message.nodeIds,
      );
    }
  }
