      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            if (state.failureNodeId != null) ...[
              const SizedBox(width: 16),
              Text(
                'Failure spotlight active',
                style: Theme.of(context).textTheme.labelSmall?.copyWith(
                  color: ArborTheme.importType,
                  fontWeight: FontWeight.bold,
                ),
              ),
            ],
            if (state.entangledNodeIds.isNotEmpty) ...[
              const SizedBox(width: 16),
              Text(
                'Entangled: ${state.entangledNodeIds.length}',
                style: Theme.of(context).textTheme.labelSmall?.copyWith(
                  color: ArborTheme.variable,
                ),
              ),
            ],
            const Spacer(),
