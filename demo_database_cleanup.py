...
def main():
    ...
    print("  ✓ Manual cleanup of old workflows")
    print("  ✓ Manual cleanup of old mappings")
    print("  ✓ Automatic cleanup (daily interval)")
    print("  ✓ Database size monitoring")
    print("  ✓ Cleanup statistics")
    print("  ✓ Space reclamation (VACUUM)")
    print("  ✓ Cleanup of all databases")
