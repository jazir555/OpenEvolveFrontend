...
class WorkflowMonitor {
    constructor(config = {}) {
        ...
        structuredLogger_1.apiLogger.info('Workflow Monitor initialized', {
            ...this.correlationContext,
            config: this.config
        });
    }
    ...
    recordWorkflowStart(context) {
        ...
        structuredLogger_1.apiLogger.debug('Workflow start recorded', {
            ...this.correlationContext,
    ...
    recordWorkflowCompletion(context, result) {
        ...
        structuredLogger_1.apiLogger.info('Workflow completion recorded', {
            ...this.correlationContext,
            workflow_id: context.workflowId,
            execution_id: context.executionId,
    ...
    recordStepExecution(context, stepId, stepName, plugin, action, startTime, endTime, success, errorMessage, retryCount = 0) {
        ...
        structuredLogger_1.apiLogger.debug('Step execution recorded', {
            ...this.correlationContext,
            step_id: stepId,
            plugin,
            action,
    ...
    clearMetrics(olderThan) {
        ...
        structuredLogger_1.apiLogger.info('Old metrics cleared', {
            ...this.correlationContext,
    ...
    clearAllMetrics() {
        ...
        structuredLogger_1.apiLogger.info('All metrics cleared', this.correlationContext);
    }
    /**
    ...
    saveToStorage() {
        try {
            ...
            structuredLogger_1.apiLogger.error('Failed to save metrics to localStorage', error, this.correlationContext);
        }
    }
    /**
    ...
    loadFromStorage() {
        try {
            ...
            if (data) {
                ...
                structuredLogger_1.apiLogger.info('Metrics loaded from localStorage', {
                    ...this.correlationContext,
            ...
            structuredLogger_1.apiLogger.error('Failed to load metrics from localStorage', error, this.correlationContext);
        }
    }
    /**
