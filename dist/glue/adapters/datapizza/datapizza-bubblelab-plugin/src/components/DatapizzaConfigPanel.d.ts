...
export declare function DatapizzaConfigPanel({ initialConfig, onSave, onCancel, showAdvanced }: DatapizzaConfigPanelProps): JSX.Element;
//# sourceMappingURL=DatapizzaConfigPanel.d.ts.map