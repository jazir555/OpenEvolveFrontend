...
export declare function DatapizzaPipelinePanel({ dataSource, initialPipelineType, onResult, onClose, showDebug, client }: DatapizzaPipelinePanelProps): JSX.Element;
//# sourceMappingURL=DatapizzaPipelinePanel.d.ts.map