...
exports.useDatapizzaProcessing = useDatapizzaProcessing;
const react_1 = require("react");
function useDatapizzaProcessing(client) {
    const [isLoading, setIsLoading] = (0, react_1.useState)(false);
    const [progress, setProgress] = (0, react_1.useState)(0);
    const [error, setError] = (0, react_1.useState)(null);
    const processData = (0, react_1.useCallback)(async (data, options = {}) => {
        setIsLoading(true);
        setError(null);
        setProgress(0);
        ...
        try {
            ...
            try {
                ...
                return {
                    ...
                    confidenceScore: 1.0, // API doesn't return confidence, assume success
