...
exports.useDatapizzaQuery = useDatapizzaQuery;
const react_1 = require("react");
function useDatapizzaQuery(client) {
    const [isLoading, setIsLoading] = (0, react_1.useState)(false);
    const [error, setError] = (0, react_1.useState)(null);
    const queryData = (0, react_1.useCallback)(async (query, options = {}) => {
        setIsLoading(true);
        setError(null);
...
//# sourceMappingURL=useDatapizzaQuery.js.map