...
exports.DEFAULT_DATAPIZZA_CONFIG = exports.DATAPIZZA_DATA_DOMAINS = exports.DATAPIZZA_PIPELINE_TYPES = void 0;
function getDefaultDatapizzaServerUrl() {
    return import.meta.env.VITE_DATAPIZZA_SERVER_URL || 'http://localhost:3000/datapizza';
}
exports.DATAPIZZA_PIPELINE_TYPES = [
    {
        value: 'standard',
...
exports.DATAPIZZA_DATA_DOMAINS = [
