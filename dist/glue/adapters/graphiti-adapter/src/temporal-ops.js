...
exports.GraphitiTemporalOps = void 0;
const uuid_1 = require("uuid");
// ============================================================================
// TEMPORAL OPERATIONS
// ============================================================================
class GraphitiTemporalOps {
    ...
    async queryAtPointInTime(query, timestamp, maxResults = 10, correlationId) {
        ...
        try {
            ...
            this.log.error('Point-in-time query failed', error, {
                correlation_id: correlationId,
                query,
                timestamp,
            });
     ...
     */
    async searchTimeRange(query, startTime, endTime, maxResults = 10, correlationId) {
        ...
        try {
            ...
            this.log.error('Time-range search failed', error, {
                correlation_id: correlationId,
                query,
                start_time: startTime,
                end_time: endTime,
    ...
    async getEntityTimeline(entityName, startTime, endTime, correlationId) {
        ...
        try {
            ...
            this.log.error('Failed to get entity timeline', error, {
                correlation_id: correlationId,
                entity: entityName,
                start_time: startTime,
                end_time: endTime,
     ...
     */
    async detectContradictions(entityName, correlationId) {
        ...
        try {
            ...
            this.log.error('Failed to detect temporal contradictions', error, {
                correlation_id: correlationId,
                entity: entityName,
            });
            throw error;
     ...
     */
    async getKnowledgeEvolution(entityName, startTime, endTime, correlationId) {
        ...
        try {
            ...
            this.log.error('Failed to get knowledge evolution', error, {
                correlation_id: correlationId,
                entity: entityName,
            });
            throw error;
...
exports.GraphitiTemporalOps = GraphitiTemporalOps;
//# sourceMappingURL=temporal-ops.js.map