...
exports.setupMemoryAgent = setupMemoryAgent;
exports.example1_MemoryEnhancedRequest = example1_MemoryEnhancedRequest;
exports.example2_DirectMemoryUsage = example2_DirectMemoryUsage;
exports.example3_ManualMemoryStorage = example3_ManualMemoryStorage;
exports.example4_SessionLearning = example4_SessionLearning;
exports.example5_PatternAnalysis = example5_PatternAnalysis;
const adapter_1 = require("../src/adapter");
const graphiti_adapter_1 = require("@openevolve/graphiti-adapter");
// ============================================================================
// CONFIGURATION
// ============================================================================
...
// SETUP
// ============================================================================
async function setupMemoryAgent() {
    console.log('Setting up ICR adapter with Graphiti memory integration...');
    // Create Graphiti adapter
    const graphitiAdapter = new graphiti_adapter_1.GraphitiAdapter({
    ...
    const icrAdapter = new adapter_1.ICRAdapter({
...
// ============================================================================
async function example1_MemoryEnhancedRequest(icrAdapter) {
    console.log('\n=== Example 1: Memory-Enhanced Contextual Request ===\n');
    ...
    try {
        const response = await icrAdapter.createContextualRequestWithMemory(prompt, {
            context_window: 5,
...
// ============================================================================
async function example2_DirectMemoryUsage(memoryAgent) {
    console.log('\n=== Example 2: Direct Memory Agent Usage ===\n');
    // Retrieve historical knowledge
    const query = 'React performance optimization with useMemo and useCallback';
    console.log('Query:', query);
    const enrichedContext = await memoryAgent.retrieveHistoricalKnowledge(query, 10, // context window
...
// ============================================================================
async function example3_ManualMemoryStorage(memoryAgent, sessionId) {
    console.log('\n=== Example 3: Manual Memory Storage ===\n');
    ...
    await memoryAgent.storeRefinementInsights(refinementInsights, sessionId);
...
// ============================================================================
async function example4_SessionLearning(memoryAgent, sessionId) {
    console.log('\n=== Example 4: Learning from Session Outcomes ===\n');
    ...
    const learningResult = await memoryAgent.learnFromSession(contextualSession, sessionOutcomes);
    console.log('\n✓ Learning completed');
...
// ============================================================================
async function example5_PatternAnalysis(memoryAgent) {
    console.log('\n=== Example 5: Pattern Analysis ===\n');
