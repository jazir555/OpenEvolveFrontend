...
const icr_client_1 = require("../src/icr-client");
const adapter_1 = require("../src/adapter");
const icr_canonical_1 = require("../src/icr-canonical");
...
describe('ICR Adapter Contract Tests', () => {
    ...
    beforeEach(() => {
        ...
        client = new icr_client_1.ICRClient();
        adapter = new adapter_1.ICRAdapter({ client });
    });
    // ==========================================================================
    ...
    describe('Refine Mode Contract', () => {
        it('should accept valid Refine mode request', () => {
            ...
            const result = icr_canonical_1.RefineModeRequestSchema.safeParse(request);
    ...
    describe('React Mode Contract', () => {
        it('should accept valid React mode request', () => {
            ...
            const result = icr_canonical_1.ReactModeRequestSchema.safeParse(request);
            expect(result.success).toBe(true);
        });
    ...
    describe('Deepthink Mode Contract', () => {
        it('should accept valid Deepthink mode request', () => {
            ...
            const result = icr_canonical_1.DeepthinkModeRequestSchema.safeParse(request);
            expect(result.success).toBe(true);
        });
    ...
    describe('All 7 Modes Contract', () => {
        ...
        it('should validate request schemas for all modes', () => {
            ...
            requests.forEach((req) => {
                ...
                switch (req.mode) {
                    case 'refine':
                        schema = icr_canonical_1.RefineModeRequestSchema;
                        break;
                    case 'react':
                        schema = icr_canonical_1.ReactModeRequestSchema;
                        break;
                    case 'deepthink':
                        schema = icr_canonical_1.DeepthinkModeRequestSchema;
                        break;
                    case 'adaptive_deepthink':
                        schema = icr_canonical_1.AdaptiveDeepthinkRequestSchema;
                        break;
                    case 'agentic':
                        schema = icr_canonical_1.AgenticModeRequestSchema;
                        break;
                    case 'contextual':
                        schema = icr_canonical_1.ContextualModeRequestSchema;
                        break;
                    case 'generative_ui':
                        schema = icr_canonical_1.GenerativeUIModeRequestSchema;
                        break;
                }
