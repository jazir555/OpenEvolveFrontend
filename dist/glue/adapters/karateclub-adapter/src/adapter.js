...
exports.KarateClubAdapter = void 0;
...
class KarateClubAdapter {
    constructor(config = {}) {
        ...
        this.client = new ml_client_1.KarateClubMLClient(config);
        this.metrics = {
            totalRequests: 0,
     ...
     * Update metrics
     */
    updateMetrics(success, executionTimeMs) {
    ...
    async generateNodeEmbeddings(request) {
        ...
        // Validate request
        const validation = (0, karateclub_canonical_1.validateNodeEmbeddingRequest)(request);
    ...
    async detectCommunities(request) {
        ...
        // Validate request
        const validation = (0, karateclub_canonical_1.validateCommunityDetectionRequest)(request);
        if (!validation.success) {
    ...
    async analyzeGraph(request) {
        ...
        // Validate request
        const validation = (0, karateclub_canonical_1.validateGraphAnalysisRequest)(request);
        if (!validation.success) {
...
exports.KarateClubAdapter = KarateClubAdapter;
