...
export declare function EnhancedLeanAideVerification({ problemStatement, solutionCode, onVerificationResult, mode, className, enableAnalytics, onAnalyticsEvent, strategy, domain, }: EnhancedLeanAideVerificationProps): JSX.Element;
export interface AnalyticsDashboardProps {
    className?: string;
    metrics?: AutoformalizationMetrics;
}
export declare function AnalyticsDashboard({ className, metrics: externalMetrics }: AnalyticsDashboardProps): JSX.Element;
export interface KnowledgeGraphIntegrationProps {
    className?: string;
}
export declare function KnowledgeGraphIntegration({ className }: KnowledgeGraphIntegrationProps): JSX.Element;
export interface LeanAideBubbleLabIntegrationProps {
    className?: string;
}
export declare function LeanAideBubbleLabIntegration({ className }: LeanAideBubbleLabIntegrationProps): JSX.Element;
export default LeanAideBubbleLabIntegration;
//# sourceMappingURL=autoformalizationAnalytics.d.ts.map