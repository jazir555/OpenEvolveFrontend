 ...
 */
import { EvolutionConfig, AdversarialConfig, DecompositionConfig } from './plugin-types';
/**
...
export declare const EXTENDED_OPENEVOLVE_PLUGIN_CONSTANTS: {
    ...
    MULTI_OBJECTIVE_DEFAULTS: {
        objectives: null;
        objective_weights: never[];
        pareto_front_size: number;
        dominance_metric: string;
        constraint_handling: string;
        reference_point: never[];
        crowding_distance: boolean;
        epsilon_dominance: number;
        decomposition_method: string;
        scalarization_function: string;
        dominance_type: string;
        epsilon_values: never[];
        scalarization: string;
        constraint_tolerance: number;
        hypervolume_ref: never[];
    };
    ...
    CUSTOM_REQUIREMENTS_DEFAULTS: {
        custom_fitness: string;
        custom_operators: never[];
        custom_constraints: never[];
        domain_knowledge: string;
        expert_rules: never[];
        business_logic: string;
        regulatory_compliance: never[];
        ethical_guidelines: never[];
    };
...
//# sourceMappingURL=extended-plugin-types.d.ts.map