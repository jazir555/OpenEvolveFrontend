 ...
 */
import { RomaPlugin, RomaPluginState } from '../types/plugin-types';
/**
 ...
 * ```
 */
export declare function useRomaPlugin(): UseRomaPluginReturn;
//# sourceMappingURL=useRomaPlugin.d.ts.map