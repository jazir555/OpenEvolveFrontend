...
async function verify() {
    ...
    try {
        const monitoring = await (0, index_1.initializeMonitoring)({
    ...
    try {
        const metrics = (0, index_1.getMetricsCollector)();
        // Record some test metrics
        metrics.recordHttpRequestDuration({ service: 'test', operation: 'test', status: '2xx' }, 0.5);
    ...
    try {
        const health = new index_1.HealthChecker('test-service');
    ...
    try {
        const tracer = (0, index_1.getTracer)('test-service');
    ...
    try {
        const alerts = (0, index_1.getAlertManager)('test-service');
