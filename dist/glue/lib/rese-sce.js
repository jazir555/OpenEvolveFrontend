...
exports.SymbolicConstraintEngine = exports.ConsistencyChecker = exports.ContradictionDetector = exports.LogicalFallacyInternal = exports.ConstraintCategoryInternal = exports.ConstraintType = void 0;
...
(function (ConstraintType) {
    ConstraintType["HARD"] = "hard";
    ConstraintType["SOFT"] = "soft";
 ...
 */
var ConstraintCategoryInternal;
(function (ConstraintCategoryInternal) {
    ConstraintCategoryInternal["HARD_PARAMETER_INEQUALITY"] = "hard_parameter_inequality";
    ConstraintCategoryInternal["SOFT_STATISTICAL"] = "soft_statistical";
    ConstraintCategoryInternal["TACIT_ASSUMPTION"] = "tacit_assumption";
    ConstraintCategoryInternal["INVERTED_CONSTRAINT"] = "inverted_constraint";
})(ConstraintCategoryInternal || (exports.ConstraintCategoryInternal = ConstraintCategoryInternal = {}));
/**
 * Logical Fallacy Types
 *
 * From RESE Technical Manual §3.3: Formal Logic Audit
 */
var LogicalFallacyInternal;
(function (LogicalFallacyInternal) {
...
})(LogicalFallacyInternal || (exports.LogicalFallacyInternal = LogicalFallacyInternal = {}));
// ============================================================================
...
class ContradictionDetector {
     ...
     */
    async detectContradictions(constraints, correlationId) {
        ...
        if (this.circuitBreaker.getState() === circuit_breaker_1.CircuitState.OPEN) {
        ...
        try {
            ...
            this.logger.error('Contradiction detection failed', error, {
                correlation_id: correlationId,
                constraint_count: constraints.length,
            });
            throw error;
     ...
     * @private
     */
    async detectContradictionsInternal(constraints, correlationId) {
     ...
     * @private
     */
    checkPairwiseContradiction(c1, c2) {
     ...
     * @private
     */
    hasCircularDependency(c1, c2) {
        return (c1.dependencies.includes(c2.constraint_id) &&
     ...
     * @private
     */
    calculateContradictionSetSize(c1, c2) {
...
class ConsistencyChecker {
     ...
     */
    async checkConsistency(constraints, correlationId) {
        ...
        if (constraints.length > this.config.MAX_CONSTRAINTS) {
            issues.push(`Constraint count ${constraints.length} exceeds maximum ${this.config.MAX_CONSTRAINTS}`);
        }
...
class SymbolicConstraintEngine {
    constructor() {
        this.logger = new logger_1.Logger('SymbolicConstraintEngine');
    ...
    async addConstraint(constraint, correlationId) {
        ...
        if (this.constraints.size >= this.config.MAX_CONSTRAINTS) {
            throw new Error(`Cannot add constraint: maximum limit ${this.config.MAX_CONSTRAINTS} reached`);
        }
    ...
    async detectContradictions(correlationId) {
        ...
        const result = await this.contradictionDetector.detectContradictions(constraints, correlationId);
     ...
     * @returns Consistency check result
     */
    async checkConsistency(correlationId) {
        const constraints = this.getAllConstraints();
     ...
     */
    async mineTacitAssumptions(failurePatterns, correlationId) {
     ...
     * @private
     */
    inferAssumptionFromPattern(patternDescription) {
     ...
     */
    async performEpistemicAudit(problemDescription, failurePatterns, correlationId) {
        const startTime = Date.now();
        ...
        const tacitAssumptions = await this.mineTacitAssumptions(failurePatterns, correlationId);
        ...
        const contradictions = contradictionResult.contradictions.map((c) => ({
            id: (0, uuid_1.v4)(),
            fallacy_type: this.mapLogicalFallacy(c.type),
...
exports.SymbolicConstraintEngine = SymbolicConstraintEngine;
// ============================================================================
// EXPORTS
// ============================================================================
exports.default = SymbolicConstraintEngine;
//# sourceMappingURL=rese-sce.js.map