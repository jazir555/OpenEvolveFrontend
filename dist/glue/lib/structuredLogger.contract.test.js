...
describe('StructuredLogger Contract Tests', () => {
    ...
    beforeEach(() => {
        ...
        console.log = (...args) => consoleOutput.push(args[0]);
        console.warn = (...args) => consoleOutput.push(args[0]);
        console.error = (...args) => consoleOutput.push(args[0]);
        console.debug = (...args) => consoleOutput.push(args[0]);
        logger = new structuredLogger_1.StructuredLogger('test-service');
    });
    afterEach(() => {
        // Restore console
    ...
    describe('Log Levels', () => {
        ...
        it('should respect minimum log level', () => {
            const strictLogger = new structuredLogger_1.StructuredLogger('test', 'warn');
    ...
    describe('Context Merging', () => {
        ...
        it('should not include internal context fields as root', () => {
            ...
            expect(Object.keys(logEntry).filter(k => ['correlation_id', 'source_service', 'target_service'].includes(k)).length).toBeGreaterThanOrEqual(3);
        });
    });
    describe('Service Name Handling', () => {
        it('should use provided service name', () => {
            const customLogger = new structuredLogger_1.StructuredLogger('custom-service-name');
    ...
    describe('Logger Configuration', () => {
        it('should allow changing minimum log level', () => {
            const testLogger = new structuredLogger_1.StructuredLogger('test', 'info');
    ...
    describe('Default Logger Instances', () => {
        it('should export default logger instances', () => {
            ...
            expect(() => {
                ...
                expect(defaultLogger).toBeInstanceOf(structuredLogger_1.StructuredLogger);
                expect(apiLogger).toBeInstanceOf(structuredLogger_1.StructuredLogger);
                expect(ragbitsLogger).toBeInstanceOf(structuredLogger_1.StructuredLogger);
            }).not.toThrow();
        });
    });
});
//# sourceMappingURL=structuredLogger.contract.test.js.map