...
class OIDCProvider {
    ...
    static fromEnv() {
        ...
        config.cookieSameSite = (process.env['OIDC_COOKIE_SAME_SITE'] || 'lax');
     ...
     */
    generateAuthorizationUrl(state, nonce, redirectPath) {
     ...
     * @returns Token set
     */
    async exchangeCodeForTokens(code, state, expectedState) {
     ...
     * @returns Logout URL
     */
    generateLogoutUrl(idToken, postLogoutRedirectUri) {
