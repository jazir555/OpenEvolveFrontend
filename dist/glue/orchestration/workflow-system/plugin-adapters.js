...
class OpenEvolveApiAdapter {
    ...
    async getGauntlet(gauntletName) {
    ...
    async getWorkflowPlan(workflowId) {
    ...
    async startEvolutionRun(payload) {
    ...
    async executeWorkflowTemplate(templateId, payload) {
        return await this.api.executeWorkflowTemplate(templateId, payload, { apiKey: this.config.apiKey });
    }
    async getWorkflowTemplateExecutionStatus(executionId) {
    ...
    async getExecutionStatus(executionType, executionId) {
