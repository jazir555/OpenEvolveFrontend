 ...
 * ```
 */
export declare function usePluginRegistry(): import("./plugin-registry").PluginRegistry | null;
/**
 ...
 * ```
 */
export declare function useWorkflowOrchestrator(): import("./workflow-orchestrator").WorkflowOrchestrator | null;
