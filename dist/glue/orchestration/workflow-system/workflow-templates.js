...
exports.WORKFLOW_TEMPLATES = exports.GAUNTLET_DECOMPOSITION_WORKFLOW = exports.DECOMPOSITION_EXECUTION_WORKFLOW = exports.GAUNTLET_EXECUTION_WORKFLOW = exports.PROBLEM_SOLVING_WORKFLOW = exports.KNOWLEDGE_EXTRACTION_WORKFLOW = exports.PROOF_VERIFICATION_WORKFLOW = exports.DATA_ANALYSIS_PIPELINE = exports.RESEARCH_ASSISTANT_WORKFLOW = void 0;
exports.getWorkflowTemplate = getWorkflowTemplate;
exports.getAllWorkflowTemplates = getAllWorkflowTemplates;
exports.getWorkflowTemplatesByCategory = getWorkflowTemplatesByCategory;
/**
 * Research Assistant Workflow
 *
 * Searches knowledge base, processes results, and generates insights
 */
exports.RESEARCH_ASSISTANT_WORKFLOW = {
 ...
 */
exports.DATA_ANALYSIS_PIPELINE = {
 ...
 */
exports.PROOF_VERIFICATION_WORKFLOW = {
    ...
    steps: [
        ...
        },
        {
            ...
            condition: (context) => {
                const validation = context.stepResults.get('cross-validate');
 ...
 */
exports.KNOWLEDGE_EXTRACTION_WORKFLOW = {
 ...
 */
exports.PROBLEM_SOLVING_WORKFLOW = {
    id: 'problem-solving',
...
exports.GAUNTLET_EXECUTION_WORKFLOW = {
    ...
    steps: [
        ...
        },
        {
            ...
            condition: (context) => {
                const gauntletConfig = context.stepResults.get('initialize-gauntlet');
 ...
 */
exports.DECOMPOSITION_EXECUTION_WORKFLOW = {
 ...
 */
exports.GAUNTLET_DECOMPOSITION_WORKFLOW = {
...
exports.WORKFLOW_TEMPLATES = {
    'research-assistant': exports.RESEARCH_ASSISTANT_WORKFLOW,
    'data-analysis-pipeline': exports.DATA_ANALYSIS_PIPELINE,
    'proof-verification': exports.PROOF_VERIFICATION_WORKFLOW,
    'knowledge-extraction': exports.KNOWLEDGE_EXTRACTION_WORKFLOW,
    'problem-solving': exports.PROBLEM_SOLVING_WORKFLOW,
    'gauntlet-execution': exports.GAUNTLET_EXECUTION_WORKFLOW,
    'decomposition-execution': exports.DECOMPOSITION_EXECUTION_WORKFLOW,
    'gauntlet-decomposition-integrated': exports.GAUNTLET_DECOMPOSITION_WORKFLOW
};
/**
 * Get workflow template by ID
 */
function getWorkflowTemplate(id) {
    return exports.WORKFLOW_TEMPLATES[id];
}
/**
 * Get all workflow templates
 */
function getAllWorkflowTemplates() {
    return Object.values(exports.WORKFLOW_TEMPLATES);
}
/**
...
function getWorkflowTemplatesByCategory(category) {
    ...
    return ids.map(id => exports.WORKFLOW_TEMPLATES[id]).filter(Boolean);
}
