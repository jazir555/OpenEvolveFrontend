...
exports.LeanAideExamples = exports.LeanCompilationResponse = exports.LeanCompilationRequest = exports.ProofVerificationResponse = exports.ProofVerificationRequest = exports.LeanMessage = exports.LeanSeverity = exports.LeanTactic = void 0;
exports.transformLeanAideResponseToCanonical = transformLeanAideResponseToCanonical;
exports.transformCanonicalToLeanAideRequest = transformCanonicalToLeanAideRequest;
exports.transformCompilationResponseToCanonical = transformCompilationResponseToCanonical;
exports.validateProofVerificationRequest = validateProofVerificationRequest;
exports.validateProofVerificationResponse = validateProofVerificationResponse;
exports.validateLeanCompilationRequest = validateLeanCompilationRequest;
exports.validateLeanCompilationResponse = validateLeanCompilationResponse;
 ...
 */
exports.LeanTactic = zod_1.z.enum([
    'intros',
    'apply',
    'exact',
    'refine',
 ...
 */
exports.LeanSeverity = zod_1.z.enum([
    'error',
    'warning',
    'info',
    'hint',
 ...
 */
exports.LeanMessage = zod_1.z.object({
    severity: exports.LeanSeverity.describe("Severity level of the message"),
    ...
    end_column: zod_1.z.number().int().nonnegative().optional()
        .describe("End column number for multiline messages"),
    message: zod_1.z.string().describe("The message text"),
    code: zod_1.z.string().optional().describe("Error code if applicable"),
});
/**
 ...
 */
exports.ProofVerificationRequest = zod_1.z.object({
    // The Lean 4 proof code to verify
    proof_code: zod_1.z.string()
...
exports.ProofVerificationResponse = zod_1.z.object({
    ...
    metadata: zod_1.z.object({
        ...
        tactics_count: zod_1.z.number().optional().describe("Number of tactics used"),
 ...
 */
exports.LeanCompilationRequest = zod_1.z.object({
 ...
 */
exports.LeanCompilationResponse = zod_1.z.object({
    // Whether the compilation was successful
    compiled: zod_1.z.boolean().describe("Whether the code compiled successfully"),
    // Warnings from the compiler
    warnings: zod_1.z.array(exports.LeanMessage).optional()
    ...
    metadata: zod_1.z.object({
        lean_version: zod_1.z.string().optional().describe("Lean 4 version used"),
        compilation_time_ms: zod_1.z.number().optional()
            .describe("Actual compilation time in milliseconds"),
        memory_used_mb: zod_1.z.number().optional().describe("Memory usage in MB"),
        lines_of_code: zod_1.z.number().optional().describe("Number of lines compiled"),
    }).optional().describe("Execution metadata"),
    // Original correlation ID for tracing
    correlation_id: zod_1.z.string().uuid().optional()
        .describe("Correlation ID for distributed tracing"),
 ...
 */
function transformLeanAideResponseToCanonical(rawResponse, correlationId) {
    const timestamp = new Date().toISOString();
    // Convert raw messages to canonical format
    const messages = (rawResponse.messages || []).map((msg) => ({
        severity: exports.LeanSeverity.parse(msg.severity || 'info'),
        line: msg.line,
        column: msg.column,
 ...
 */
function transformCanonicalToLeanAideRequest(canonicalRequest) {
    return {
 ...
 */
function transformCompilationResponseToCanonical(rawResponse, correlationId) {
    const timestamp = new Date().toISOString();
    // Convert raw messages to canonical format
    const warnings = (rawResponse.warnings || []).map((msg) => ({
        severity: exports.LeanSeverity.parse('warning'),
        line: msg.line,
        column: msg.column,
        message: msg.message || msg.text,
    }));
    const errors = (rawResponse.errors || []).map((msg) => ({
        severity: exports.LeanSeverity.parse('error'),
        line: msg.line,
        column: msg.column,
        message: msg.message || msg.text,
        code: msg.code,
 ...
 */
function validateProofVerificationRequest(data) {
    const result = exports.ProofVerificationRequest.safeParse(data);
    if (result.success) {
 ...
 */
function validateProofVerificationResponse(data) {
    const result = exports.ProofVerificationResponse.safeParse(data);
    if (result.success) {
        return { success: true, data: result.data };
    }
    return {
 ...
 */
function validateLeanCompilationRequest(data) {
    const result = exports.LeanCompilationRequest.safeParse(data);
    if (result.success) {
        return { success: true, data: result.data };
    }
    return {
 ...
 */
function validateLeanCompilationResponse(data) {
    const result = exports.LeanCompilationResponse.safeParse(data);
    if (result.success) {
        return { success: true, data: result.data };
    }
    return {
...
//# sourceMappingURL=leanaide-canonical.js.map