...
exports.RAGExamples = exports.RAGError = exports.DocumentIngestionResponse = exports.DocumentIngestionRequest = exports.RAGResponse = exports.RAGRequest = exports.DocumentChunk = void 0;
exports.transformRAGResponseToCanonical = transformRAGResponseToCanonical;
exports.transformCanonicalToRAGRequest = transformCanonicalToRAGRequest;
exports.validateRAGRequest = validateRAGRequest;
exports.validateRAGResponse = validateRAGResponse;
exports.validateDocumentChunk = validateDocumentChunk;
exports.isRAGRequest = isRAGRequest;
exports.isRAGResponse = isRAGResponse;
 ...
 */
exports.DocumentChunk = zod_1.z.object({
    id: zod_1.z.string().uuid().describe("Unique identifier for the document chunk"),
 ...
 */
exports.RAGRequest = zod_1.z.object({
    ...
    retrieval_count: zod_1.z.number()
 ...
 */
exports.RAGResponse = zod_1.z.object({
    results: zod_1.z.array(exports.DocumentChunk)
 ...
 */
exports.DocumentIngestionRequest = zod_1.z.object({
    content: zod_1.z.string()
 ...
 */
exports.RAGError = zod_1.z.object({
    code: zod_1.z.enum([
        'QUERY_TOO_LONG',
        'RETRIEVAL_FAILED',
        'GENERATION_FAILED',
 ...
 */
function transformRAGResponseToCanonical(rawResponse, correlationId) {
    const timestamp = new Date().toISOString();
    return {
        results: (rawResponse.results || []).map((chunk) => ({
 ...
 */
function transformCanonicalToRAGRequest(canonicalRequest) {
    return {
 ...
 */
function validateRAGRequest(data) {
    const result = exports.RAGRequest.safeParse(data);
    if (result.success) {
...
function validateRAGResponse(data) {
    const result = exports.RAGResponse.safeParse(data);
    if (result.success) {
        return { success: true, data: result.data };
    }
    return {
 ...
 */
function validateDocumentChunk(data) {
    const result = exports.DocumentChunk.safeParse(data);
    if (result.success) {
        return { success: true, data: result.data };
    }
    return {
...
//# sourceMappingURL=ragbits-canonical.js.map