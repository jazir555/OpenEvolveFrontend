...
exports.adapterUsageExample = adapterUsageExample;
...
function testZ3Schemas() {
    ...
    const solverRequestValidation = (0, index_1.validateSolverRequest)(index_1.Z3Examples.validSolverRequest);
    ...
    const solverResponseValidation = (0, index_1.validateSolverResponse)(index_1.Z3Examples.validSolverResponse);
    ...
    const kgValidation = (0, index_1.validateKnowledgeGraphResponse)(index_1.Z3Examples.validKnowledgeGraphResponse);
    ...
    const invalidValidation = (0, index_1.validateSolverRequest)(invalidRequest);
    ...
    const invalidResponseValidation = (0, index_1.validateSolverResponse)(invalidResponse);
...
function testLeanAideSchemas() {
    ...
    const proofRequestValidation = (0, index_1.validateProofVerificationRequest)(index_1.LeanAideExamples.validProofVerificationRequest);
    ...
    const proofResponseValidation = (0, index_1.validateProofVerificationResponse)(index_1.LeanAideExamples.validProofVerificationResponse);
    ...
    const compilationRequestValidation = (0, index_1.validateLeanCompilationRequest)(index_1.LeanAideExamples.validLeanCompilationRequest);
    ...
    const compilationResponseValidation = (0, index_1.validateLeanCompilationResponse)(index_1.LeanAideExamples.validLeanCompilationResponse);
    ...
    const errorResponseValidation = (0, index_1.validateProofVerificationResponse)(index_1.LeanAideExamples.proofVerificationWithError);
    ...
    const invalidProofValidation = (0, index_1.validateProofVerificationRequest)(invalidProofRequest);
...
function testUtilityFunctions() {
    ...
    const correlationId = (0, index_1.createCorrelationId)();
    ...
    const timestamp = (0, index_1.createUTCTimestamp)();
    ...
    console.log(`  QUICK: ${index_1.DEFAULT_TIMEOUTS.QUICK}ms (${index_1.DEFAULT_TIMEOUTS.QUICK / 1000}s)`);
    console.log(`  NORMAL: ${index_1.DEFAULT_TIMEOUTS.NORMAL}ms (${index_1.DEFAULT_TIMEOUTS.NORMAL / 1000}s)`);
    console.log(`  LONG: ${index_1.DEFAULT_TIMEOUTS.LONG}ms (${index_1.DEFAULT_TIMEOUTS.LONG / 1000}s)`);
    console.log(`  EXTENDED: ${index_1.DEFAULT_TIMEOUTS.EXTENDED}ms (${index_1.DEFAULT_TIMEOUTS.EXTENDED / 1000}s)`);
...
function adapterUsageExample() {
    ...
    const validation = (0, index_1.validateSolverRequest)(incomingRequest);
    ...
    const response = {
        ...
        correlation_id: request.correlation_id || (0, index_1.createCorrelationId)(),
        timestamp: (0, index_1.createUTCTimestamp)(),
    };
    const responseValidation = (0, index_1.validateSolverResponse)(response);
