...
- [x] **Read**: `BUBBLELAB_TO_BUBBLELAB_MIGRATION.md` (full migration plan)
...
1. **Catalog ALL BubbleLab UI files** (399 imports identified)
   ...
   - Document each file's purpose in `BUBBLELAB_FILES_INVENTORY.md`
...
├── LeanAide/server/bubblelabs_ui.py
