...
# Make peer modules resolvable under the flat sys.path import model.
import os
import sys as _sys

_ORCH_DIR = os.path.dirname(os.path.abspath(__file__))
_ENGINES_DIR = os.path.dirname(_ORCH_DIR)
_REPO_ROOT = os.path.dirname(_ENGINES_DIR)
for _d in (
    os.path.join(_ENGINES_DIR, "alerting"),
    os.path.join(_ENGINES_DIR, "other"),
    os.path.join(_ENGINES_DIR, "knowledge"),
    os.path.join(_REPO_ROOT, "scripts"),
    os.path.join(_REPO_ROOT, "integrations", "z3"),
):
