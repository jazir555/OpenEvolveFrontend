...
export class DatapizzaClient {
    ...
    async testConnection() {
        ...
        try {
            ...
            logger.error('Datapizza connection test failed', error, context);
            throw error;
        }
    }
    /**
    ...
    async runPipeline(request) {
        ...
        try {
            ...
            logger.error('Pipeline run error', error, context);
            throw error;
        }
    }
    /**
    ...
    async processData(request) {
        ...
        try {
            ...
            logger.error('Data processing error', error, context);
            throw error;
        }
    }
    /**
    ...
    async queryData(request) {
        ...
        try {
            ...
            logger.error('Data query error', error, context);
            throw error;
        }
    }
    /**
    ...
    async getPipelineRecommendation(dataSource, context) {
        ...
        try {
            ...
            logger.error('Pipeline recommendation error', error, logContext);
            throw error;
        }
    }
    /**
    ...
    async detectDataDomain(data) {
        ...
        try {
            ...
            logger.error('Domain detection error', error, context);
            throw error;
        }
    }
    /**
    ...
    async isProcessableData(data) {
        ...
        try {
            ...
            logger.error('Processable check error', error, context);
            return false;
        }
    }
    /**
    ...
    async clearCache() {
        ...
        try {
            ...
            logger.error('Cache clear error', error, context);
            throw error;
        }
    }
    /**
