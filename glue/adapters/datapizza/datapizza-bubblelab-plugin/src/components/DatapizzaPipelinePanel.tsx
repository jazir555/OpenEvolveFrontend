...
export function DatapizzaPipelinePanel({
  ...
  const [localResult, setLocalResult] = useState<DatapizzaPipelineResult | null>(null);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 h-full">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    disabled={!isRunning && !localResult}
                    className="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50"
                  >
            ...
            <div className="lg:col-span-1 space-y-4">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                ...
                <div className="flex items-center gap-2">
                  {!isRunning && !localResult && !hookError && (
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-full bg-gray-200 dark:bg-gray-600 rounded-full h-2.5">
                    <div
                      className={`bg-blue-600 h-2.5 rounded-full transition-all duration-300 ${hookError ? 'bg-red-600' : ''} ${localResult?.success ? 'bg-green-600' : ''}`}
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">{(localResult.processedData as any)?.recordsProcessed || 'N/A'}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600 dark:text-gray-300">Chunks Created:</span>
                      <span className="font-medium">{(localResult.processedData as any)?.chunksCreated || 'N/A'}</span>
                    </div>
                  </div>
                </div>
              )}
