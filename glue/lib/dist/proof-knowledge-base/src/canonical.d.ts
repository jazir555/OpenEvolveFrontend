...
export declare const Theorem: z.ZodObject<{
    ...
    id: string;
    type: "other" | "lemma" | "theorem" | "corollary" | "proposition" | "definition" | "axiom" | "conjecture";
    statement: string;
    created_at: string;
...
export declare const FormalProof: z.ZodObject<{
    ...
    status: "unknown" | "valid" | "invalid" | "partial" | "pending_validation";
    id: string;
    system: "leanaide" | "z3" | "other" | "coq" | "isabelle" | "hol";
...
export declare const ProofDependency: z.ZodObject<{
    ...
    id: string;
    type: "other" | "direct_dependency" | "indirect_dependency" | "import" | "definition_used" | "theorem_applied" | "axiom_referenced";
    created_at: string;
    proof_id: string;
