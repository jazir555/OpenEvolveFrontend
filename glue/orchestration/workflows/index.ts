...
export {
  ...
  KnowledgeExtractionWorkflowConfig,
...
export {
  ...
  AdaptiveExecutionWorkflowConfig,
  AdaptiveExecutionInput,
  ParadigmExecutionState,
  TriggerEvaluation,
...
export {
  ...
  MultiStageReasoningWorkflowConfig,
...
export const WORKFLOW_METADATA = {
  ...
  [WORKFLOWS.KNOWLEDGE_EXTRACTION]: {
  ...
  [WORKFLOWS.MULTI_STAGE_REASONING]: {
 ...
 */
export function getWorkflowMetadata(type: WorkflowType) {
  return WORKFLOW_METADATA[type];
}
