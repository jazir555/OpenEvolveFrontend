...
export declare const ContradictionDetection: z.ZodObject<{
    ...
    id: string;
    fallacy_type: "circulus_in_probando" | "confirmation_bias" | "hasty_generalization" | "false_cause" | "ad_hominem" | "straw_man" | "contradiction" | "inconsistency" | "other";
...
export declare const SynthesizedKnowledge: z.ZodObject<{
    ...
    id: string;
    description: string;
    knowledge_type: "other" | "theoretical_model" | "algorithm" | "experimental_protocol" | "verification_proof";
    title: string;
