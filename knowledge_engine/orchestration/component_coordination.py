...
class GapType(Enum):
    ...
    NO_ENTITY_EXTRACTION = "no_entity_extraction"
    NO_RELATION_EXTRACTION = "no_relation_extraction"
    NO_EMBEDDING_GENERATION = "no_embedding_generation"
    NO_GRAPH_CONSTRUCTION = "no_graph_construction"
