    ...
    **Advanced AI-Powered Content Hardening with Multi-Model Consensus**
    ...
    with config_tabs[0]:  # Model Configuration
        ...
        with col1:
            ...
            st.session_state.adversarial_red_team_sample_size = adversarial_red_team_sample_size
        ...
        with col2:
            ...
            st.session_state.adversarial_blue_team_sample_size = adversarial_blue_team_sample_size
        ...
        with col3:
            ...
            st.session_state.evaluator_models = evaluator_models
            st.session_state.evaluator_sample_size = evaluator_sample_size
        ...
        with col1:
            ...
            st.session_state.adversarial_rotation_strategy = adversarial_rotation_strategy
        ...
        with col2:
            ...
            st.session_state.enable_performance_tracking = enable_performance_tracking
        ...
        with st.expander("💬 Custom Prompts & Templates", expanded=False):
            ...
            if st.session_state.adversarial_custom_mode:
                ...
                with col1:
                    ...
                    st.session_state.adversarial_custom_red_prompt = adversarial_custom_red_prompt
                with col2:
                    ...
                    st.session_state.adversarial_custom_blue_prompt = adversarial_custom_blue_prompt
                ...
                st.session_state.adversarial_custom_approval_prompt = adversarial_custom_approval_prompt
    ...
    with config_tabs[1]:  # Process Parameters
        ...
        with col1:
            ...
            st.session_state.adversarial_min_iter = adversarial_min_iter
            st.session_state.adversarial_max_iter = adversarial_max_iter
        ...
        with col2:
            ...
            st.session_state.adversarial_confidence = adversarial_confidence
            st.session_state.evaluator_threshold = evaluator_threshold
        ...
        with col3:
            ...
            st.session_state.evaluator_consecutive_rounds = evaluator_consecutive_rounds
            st.session_state.adversarial_budget_limit = adversarial_budget_limit
        ...
        with col1:
            ...
            st.session_state.adversarial_critique_depth = adversarial_critique_depth
        ...
        with col2:
            ...
            st.session_state.adversarial_patch_quality = adversarial_patch_quality
    ...
    with config_tabs[2]:  # Advanced Features
        ...
        with col1:
            ...
            st.session_state.enable_multi_objective_optimization = enable_multi_objective_optimization
            ...
            if enable_multi_objective_optimization:
                ...
                st.session_state.feature_dimensions = feature_dimensions
                st.session_state.feature_bins = feature_bins
        ...
        with col2:
            ...
            st.session_state.enable_data_augmentation = enable_data_augmentation
            ...
            if enable_data_augmentation:
                ...
                st.session_state.augmentation_model = augmentation_model
                st.session_state.augmentation_temperature = augmentation_temperature
    ...
    with config_tabs[3]:  # Quality Control
        ...
        with col1:
            ...
            st.session_state.enable_human_feedback = enable_human_feedback
            ...
            st.session_state.keyword_analysis_enabled = keyword_analysis_enabled
        ...
        with col2:
            ...
            st.session_state.enable_real_time_monitoring = enable_real_time_monitoring
            ...
            st.session_state.enable_comprehensive_reporting = enable_comprehensive_reporting
        ...
        with col2:
            ...
            st.session_state.enable_audit_trail = enable_audit_trail
...
def render_github_tab():
    ...
    st.session_state.github_token = st.text_input("GitHub Personal Access Token", type="password", value=st.session_state.github_token)
            ...
            if not st.session_state.protocol_text.strip():
                ...
                with st.spinner(st.session_state.evolution_status_message):
                    try:
                        ...
                        st.session_state.evaluator_system_prompt = evaluator_system_prompt
                        
                        # Update conditional parameters
                        if selected_mode == "multi_objective":
                            st.session_state.objectives = objectives
                        if selected_mode == "adversarial":
                            st.session_state.adversarial_attack_model = adversarial_attack_model
                            st.session_state.adversarial_defense_model = adversarial_defense_model
                        
                        # Update OpenEvolve features
                        st.session_state.enable_artifacts = enable_artifacts
                        ...
                        st.session_state.checkpoint_interval = checkpoint_interval
