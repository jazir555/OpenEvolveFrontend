...
class RecursiveMAKERSolver:
    ...
    def __init__(
        ...
        self.vote_collector = VoteCollector(max_token_length=max_token_length)
        self.voting_engine = VotingEngine(
            vote_collector=self.vote_collector,
    ...
    def solve(
        ...
        try:
            ...
            metrics = MAKERRunMetrics(
                ...
                decompositions=self.metrics["total_decompositions"],
                atomic_solves=self.metrics["atomic_solves"],
                total_time=total_time,
                avg_confidence=0.95
            )
            ...
            return None, MAKERRunMetrics(total_time=time.time() - start_time)
