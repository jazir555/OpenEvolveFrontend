...
import { getAllWorkflowTemplates, getWorkflowTemplate } from '@/lib/workflow-templates';
import type { WorkflowDefinition, WorkflowExecutionResult } from '@/lib/workflow-orchestrator';
