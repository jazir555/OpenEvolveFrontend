...
def append_trace_jsonl(
    trace: Any, output_path: Union[str, Path], compress: bool = False
) -> None:
    """
...
def load_traces_jsonl(
    input_path: Union[str, Path], compress: bool = False
) -> List[Dict[str, Any]]:
    """
...
def export_traces(
    ...
    if format == "jsonl":
        ...
        raise ValueError(
            f"Unsupported format: {format}. Use 'jsonl', 'json', or 'hdf5'"
        )
