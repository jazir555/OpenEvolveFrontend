...
class BasePESRunner(ABC):
    ...
    def _setup_arg_parser(self) -> argparse.ArgumentParser:
        """Set up the command-line argument parser with common arguments."""
        parser = argparse.ArgumentParser(
            description="OpenEvolve PES Framework Runner: Start an evolutionary task "
    ...
    def _merge_configs(
        ...
        """Merge CLI arguments into the base configuration dictionary."""
    ...
    def _setup_logging(self, config: EvolveChainConfig) -> None:
        ...
        Args:
            config: Validated configuration with logging settings.
        """
        ...
        # Use structured JSON format (following OpenEvolve conventions)
    ...
    def _create_evaluator(self, config: EvolveChainConfig) -> Optional[Any]:
        """
