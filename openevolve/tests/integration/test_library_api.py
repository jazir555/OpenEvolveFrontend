...
class TestLibraryAPIIntegration:
    ...
    def test_evolve_function_real_integration(self, optillm_server, temp_workspace):
        ...
        print("✅ evolve_function completed successfully!")
...
"""
        ...
        print("✅ evolve_code completed successfully!")
        print(f"   Best score: {result.best_score}")
        print(f"   Output dir: {result.output_dir}")
...
""")
        ...
        print("✅ run_evolution completed successfully!")
        print(f"   Best score: {result.best_score}")
        print(f"   Output dir: {result.output_dir}")
        ...
        print("✅ run_evolution with string inputs completed!")
