...
// Module: Aesop.Frontend
// Imports: public import Init public import Aesop.Frontend.Attribute public import Aesop.Frontend.Command public import Aesop.Frontend.RuleExpr public import Aesop.Frontend.Saturate public import Aesop.Frontend.Tactic
#include <lean/lean.h>
...
lean_object* initialize_aesop_Aesop_Frontend_Saturate(uint8_t builtin);
lean_object* initialize_aesop_Aesop_Frontend_Tactic(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_aesop_Aesop_Frontend(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_aesop_Aesop_Frontend_Saturate(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
