...
// Module: Aesop.Options
// Imports: public import Init public import Aesop.Options.Internal public import Aesop.Options.Public
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_aesop_Aesop_Options(uint8_t builtin) {
lean_object * res;
