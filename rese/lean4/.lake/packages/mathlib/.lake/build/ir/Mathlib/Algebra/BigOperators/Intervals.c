...
// Imports: public import Init public import Mathlib.Algebra.Order.BigOperators.Group.LocallyFinite public import Mathlib.Algebra.Order.Interval.Finset.Basic public import Mathlib.Algebra.Order.Sub.Basic public import Mathlib.Data.Nat.Factorial.Basic
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Algebra_Order_Interval_Finset_Basic(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_BigOperators_Intervals(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Algebra_Order_Interval_Finset_Basic(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
