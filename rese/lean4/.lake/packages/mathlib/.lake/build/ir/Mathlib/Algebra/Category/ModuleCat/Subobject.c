...
// Imports: public import Init public import Mathlib.Algebra.Category.ModuleCat.EpiMono public import Mathlib.Algebra.Category.ModuleCat.Kernels public import Mathlib.CategoryTheory.Subobject.WellPowered public import Mathlib.CategoryTheory.Subobject.Limits
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_CategoryTheory_Subobject_Limits(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_Category_ModuleCat_Subobject(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_CategoryTheory_Subobject_Limits(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
