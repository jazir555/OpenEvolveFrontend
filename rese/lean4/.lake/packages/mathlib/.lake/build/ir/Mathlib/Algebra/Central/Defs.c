...
// Imports: public import Init public import Mathlib.Algebra.Algebra.Subalgebra.Lattice
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_Central_Defs(uint8_t builtin) {
lean_object * res;
