...
// Module: Mathlib.Algebra.Colimit.Module
// Imports: public import Init public import Mathlib.Algebra.Colimit.DirectLimit public import Mathlib.Algebra.DirectSum.Module public import Mathlib.Algebra.Module.Congruence.Defs public import Mathlib.Data.Finset.Order public import Mathlib.Tactic.SuppressCompilation
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Algebra_Colimit_DirectLimit(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_Colimit_Module(uint8_t builtin) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Algebra_Colimit_DirectLimit(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
