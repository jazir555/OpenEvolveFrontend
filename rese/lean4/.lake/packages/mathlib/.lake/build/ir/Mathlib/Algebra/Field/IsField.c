...
// Imports: public import Init public import Mathlib.Algebra.Field.Defs public import Mathlib.Tactic.Common
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_Field_IsField(uint8_t builtin) {
lean_object * res;
