...
// Imports: public import Init public import Mathlib.Algebra.Group.Hom.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_Group_Ext(uint8_t builtin) {
lean_object * res;
