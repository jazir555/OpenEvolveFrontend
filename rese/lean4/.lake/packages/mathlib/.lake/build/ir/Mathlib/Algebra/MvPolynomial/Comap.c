...
// Imports: public import Init public import Mathlib.Algebra.MvPolynomial.Rename
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_MvPolynomial_Comap(uint8_t builtin) {
lean_object * res;
