...
// Imports: public import Init public import Mathlib.Algebra.Polynomial.RingDivision public import Mathlib.Algebra.Polynomial.Roots public import Mathlib.Algebra.MvPolynomial.CommRing public import Mathlib.Algebra.MvPolynomial.Polynomial public import Mathlib.Algebra.MvPolynomial.Rename
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Algebra_MvPolynomial_Polynomial(uint8_t builtin);
lean_object* initialize_mathlib_Mathlib_Algebra_MvPolynomial_Rename(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_MvPolynomial_Funext(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Algebra_MvPolynomial_Polynomial(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
