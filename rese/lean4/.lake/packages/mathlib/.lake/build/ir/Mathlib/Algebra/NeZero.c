...
// Imports: public import Init public import Mathlib.Logic.Basic public import Mathlib.Order.Defs.PartialOrder
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_NeZero(uint8_t builtin) {
lean_object * res;
