...
// Imports: public import Init public import Mathlib.Algebra.Order.Ring.Canonical
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_Order_BigOperators_Ring_List(uint8_t builtin) {
lean_object * res;
