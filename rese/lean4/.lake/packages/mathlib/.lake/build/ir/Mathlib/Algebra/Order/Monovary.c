...
// Imports: public import Init public import Mathlib.Algebra.Field.Defs public import Mathlib.Algebra.Order.Module.Defs public import Mathlib.Algebra.Order.Module.Synonym public import Mathlib.Algebra.Order.Monoid.OrderDual public import Mathlib.Order.Monotone.Monovary
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Order_Monotone_Monovary(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_Order_Monovary(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Order_Monotone_Monovary(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
