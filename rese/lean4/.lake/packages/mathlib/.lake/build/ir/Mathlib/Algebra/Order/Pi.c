...
// Imports: public import Init public import Mathlib.Algebra.Notation.Lemmas public import Mathlib.Algebra.Order.Monoid.Canonical.Defs public import Mathlib.Algebra.Order.Ring.Defs public import Mathlib.Algebra.Ring.Pi
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Algebra_Notation_Lemmas(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_Order_Pi(uint8_t builtin) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Algebra_Notation_Lemmas(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
