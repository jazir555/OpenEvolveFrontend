...
// Imports: public import Init public import Mathlib.Algebra.Order.Ring.Unbundled.Basic public import Mathlib.Algebra.CharZero.Defs public import Mathlib.Algebra.Order.Group.Defs public import Mathlib.Algebra.Order.GroupWithZero.Unbundled.Basic public import Mathlib.Algebra.Order.Monoid.NatCast public import Mathlib.Algebra.Order.Monoid.Unbundled.MinMax public import Mathlib.Algebra.Ring.Defs public import Mathlib.Algebra.Ring.GrindInstances public import Mathlib.Tactic.Tauto public import Mathlib.Algebra.Order.Monoid.Unbundled.ExistsOfLE
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Algebra_Order_Ring_Unbundled_Basic(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_Order_Ring_Defs(uint8_t builtin) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Algebra_Order_Ring_Unbundled_Basic(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
