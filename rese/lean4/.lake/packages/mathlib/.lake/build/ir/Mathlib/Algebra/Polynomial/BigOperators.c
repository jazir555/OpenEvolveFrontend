...
// Imports: public import Init public import Mathlib.Algebra.Polynomial.Monic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_Polynomial_BigOperators(uint8_t builtin) {
lean_object * res;
