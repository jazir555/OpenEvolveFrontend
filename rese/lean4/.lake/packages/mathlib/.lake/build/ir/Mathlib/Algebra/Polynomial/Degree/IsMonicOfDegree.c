...
// Module: Mathlib.Algebra.Polynomial.Degree.IsMonicOfDegree
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_Polynomial_Degree_IsMonicOfDegree(uint8_t builtin) {
lean_object * res;
