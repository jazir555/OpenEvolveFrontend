...
// Imports: public import Init public import Mathlib.Algebra.Divisibility.Hom public import Mathlib.Algebra.Group.Irreducible.Lemmas public import Mathlib.Algebra.GroupWithZero.Equiv public import Mathlib.Algebra.Prime.Defs public import Mathlib.Order.Monotone.Defs
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Algebra_Group_Irreducible_Lemmas(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Algebra_Prime_Lemmas(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Algebra_Group_Irreducible_Lemmas(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
