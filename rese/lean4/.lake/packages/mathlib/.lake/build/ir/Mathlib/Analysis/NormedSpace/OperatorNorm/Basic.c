...
// Imports: public import Init public import Mathlib.Analysis.Normed.Operator.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Analysis_NormedSpace_OperatorNorm_Basic(uint8_t builtin) {
lean_object * res;
