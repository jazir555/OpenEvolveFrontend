...
// Imports: public import Init public import Mathlib.Analysis.SpecialFunctions.Complex.Log
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Analysis_SpecialFunctions_Pow_Complex(uint8_t builtin) {
lean_object * res;
