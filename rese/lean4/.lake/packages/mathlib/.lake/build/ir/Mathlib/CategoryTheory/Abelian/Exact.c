...
// Imports: public import Init public import Mathlib.Algebra.Homology.ImageToKernel public import Mathlib.Algebra.Homology.ShortComplex.Exact public import Mathlib.CategoryTheory.Abelian.Opposite public import Mathlib.CategoryTheory.Limits.Preserves.Shapes.Zero public import Mathlib.CategoryTheory.Limits.Preserves.Shapes.Kernels public import Mathlib.CategoryTheory.Adjunction.Limits public import Mathlib.Tactic.TFAE
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Algebra_Homology_ImageToKernel(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_CategoryTheory_Abelian_Exact(uint8_t builtin) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Algebra_Homology_ImageToKernel(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
