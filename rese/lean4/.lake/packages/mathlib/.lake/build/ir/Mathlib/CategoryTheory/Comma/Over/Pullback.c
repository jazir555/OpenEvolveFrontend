...
lean_object* initialize_mathlib_Mathlib_CategoryTheory_Monad_Products(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_CategoryTheory_Comma_Over_Pullback(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_CategoryTheory_Monad_Products(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
