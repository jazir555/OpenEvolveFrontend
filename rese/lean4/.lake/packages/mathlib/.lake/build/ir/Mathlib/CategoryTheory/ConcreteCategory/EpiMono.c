...
// Module: Mathlib.CategoryTheory.ConcreteCategory.EpiMono
...
lean_object* initialize_mathlib_Mathlib_CategoryTheory_MorphismProperty_Concrete(uint8_t builtin);
lean_object* initialize_mathlib_Mathlib_CategoryTheory_Types_Basic(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_CategoryTheory_ConcreteCategory_EpiMono(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_CategoryTheory_MorphismProperty_Concrete(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
