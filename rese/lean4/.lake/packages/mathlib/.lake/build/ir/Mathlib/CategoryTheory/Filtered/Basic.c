...
// Imports: public import Init public import Mathlib.CategoryTheory.Limits.Shapes.FiniteLimits
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_CategoryTheory_Filtered_Basic(uint8_t builtin) {
lean_object * res;
