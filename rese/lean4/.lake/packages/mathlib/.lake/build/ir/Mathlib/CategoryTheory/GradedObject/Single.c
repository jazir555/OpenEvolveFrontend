...
// Module: Mathlib.CategoryTheory.GradedObject.Single
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_CategoryTheory_GradedObject_Single(uint8_t builtin) {
lean_object * res;
