...
// Imports: public import Init public import Mathlib.CategoryTheory.Limits.Preserves.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_CategoryTheory_Limits_Preserves_Limits(uint8_t builtin) {
lean_object * res;
