...
// Imports: public import Init public import Mathlib.CategoryTheory.Shift.CommShift
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_CategoryTheory_Shift_Induced(uint8_t builtin) {
lean_object * res;
