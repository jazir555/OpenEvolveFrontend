...
// Imports: public import Init public import Mathlib.SetTheory.Cardinal.Finite
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Data_Finite_Card(uint8_t builtin) {
lean_object * res;
