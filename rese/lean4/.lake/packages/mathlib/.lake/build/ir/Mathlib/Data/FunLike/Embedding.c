...
// Imports: public import Init public import Mathlib.Data.FunLike.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Data_FunLike_Embedding(uint8_t builtin) {
lean_object * res;
