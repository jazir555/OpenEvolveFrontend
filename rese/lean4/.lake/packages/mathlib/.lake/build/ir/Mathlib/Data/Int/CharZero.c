...
// Imports: public import Init public import Mathlib.Algebra.Notation.Support public import Mathlib.Data.Int.Cast.Field public import Mathlib.Data.Int.Cast.Lemmas public import Mathlib.Data.Int.Cast.Pi
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Data_Int_Cast_Field(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Data_Int_CharZero(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Data_Int_Cast_Field(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
