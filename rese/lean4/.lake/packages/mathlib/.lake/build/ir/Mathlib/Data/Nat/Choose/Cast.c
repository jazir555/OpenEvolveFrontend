...
// Imports: public import Init public import Mathlib.Algebra.Field.Defs public import Mathlib.Algebra.GroupWithZero.Units.Basic public import Mathlib.Data.Nat.Choose.Basic public import Mathlib.Data.Nat.Factorial.Cast
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Data_Nat_Factorial_Cast(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Data_Nat_Choose_Cast(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Data_Nat_Factorial_Cast(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
