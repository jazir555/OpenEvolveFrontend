...
// Imports: public import Init public import Mathlib.Topology.Algebra.ConstMulAction
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Dynamics_Minimal(uint8_t builtin) {
lean_object * res;
