...
lean_object* initialize_mathlib_Mathlib_RingTheory_Polynomial_Content(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_FieldTheory_Separable(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_RingTheory_Polynomial_Content(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
