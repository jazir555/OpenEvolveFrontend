...
// Imports: public import Init public import Mathlib.RingTheory.Noetherian.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_FieldTheory_Tower(uint8_t builtin) {
lean_object * res;
