...
// Imports: public import Init public import Mathlib.GroupTheory.Perm.Cycle.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_GroupTheory_Perm_Closure(uint8_t builtin) {
lean_object * res;
