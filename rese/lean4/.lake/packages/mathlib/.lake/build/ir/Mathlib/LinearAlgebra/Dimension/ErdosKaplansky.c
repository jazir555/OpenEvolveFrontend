...
// Imports: public import Init public import Mathlib.Algebra.Field.Opposite public import Mathlib.LinearAlgebra.Basis.VectorSpace public import Mathlib.LinearAlgebra.Dimension.Constructions public import Mathlib.SetTheory.Cardinal.Subfield
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_SetTheory_Cardinal_Subfield(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_LinearAlgebra_Dimension_ErdosKaplansky(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_SetTheory_Cardinal_Subfield(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
