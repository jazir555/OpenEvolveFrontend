...
// Imports: public import Init public import Mathlib.LinearAlgebra.Dimension.Constructions public import Mathlib.LinearAlgebra.Dimension.StrongRankCondition public import Mathlib.LinearAlgebra.Dimension.Subsingleton public import Mathlib.LinearAlgebra.FreeModule.Finite.Basic public import Mathlib.SetTheory.Cardinal.Cofinality
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_LinearAlgebra_Dimension_Subsingleton(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_LinearAlgebra_Dimension_Finite(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_LinearAlgebra_Dimension_Subsingleton(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
