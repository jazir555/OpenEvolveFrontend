...
// Module: Mathlib.LinearAlgebra.Eigenspace.Zero
// Imports: public import Init public import Mathlib.Algebra.Order.Archimedean.Basic public import Mathlib.LinearAlgebra.Charpoly.ToMatrix public import Mathlib.LinearAlgebra.Determinant public import Mathlib.LinearAlgebra.Eigenspace.Minpoly public import Mathlib.LinearAlgebra.FreeModule.StrongRankCondition public import Mathlib.RingTheory.Artinian.Module
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_LinearAlgebra_Eigenspace_Minpoly(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_LinearAlgebra_Eigenspace_Zero(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_LinearAlgebra_Eigenspace_Minpoly(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
