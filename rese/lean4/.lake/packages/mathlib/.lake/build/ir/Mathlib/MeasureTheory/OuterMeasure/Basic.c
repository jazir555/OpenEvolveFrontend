...
// Imports: public import Init public import Mathlib.Data.Countable.Basic public import Mathlib.Data.Fin.VecNotation public import Mathlib.Order.Disjointed public import Mathlib.MeasureTheory.OuterMeasure.Defs public import Mathlib.Topology.Instances.ENNReal.Lemmas
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_MeasureTheory_OuterMeasure_Defs(uint8_t builtin);
lean_object* initialize_mathlib_Mathlib_Topology_Instances_ENNReal_Lemmas(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_MeasureTheory_OuterMeasure_Basic(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_MeasureTheory_OuterMeasure_Defs(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
