...
// Imports: public import Init public import Mathlib.Data.Set.Defs public import Mathlib.Tactic.TypeStar
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Order_Bounds_Defs(uint8_t builtin) {
lean_object * res;
