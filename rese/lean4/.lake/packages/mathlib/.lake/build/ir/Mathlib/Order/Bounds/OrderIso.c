...
// Imports: public import Init public import Mathlib.Order.Bounds.Image public import Mathlib.Order.Hom.Set
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Order_Bounds_OrderIso(uint8_t builtin) {
lean_object * res;
