...
// Imports: public import Init public import Mathlib.Algebra.Order.Archimedean.Basic public import Mathlib.Order.Filter.AtTopBot.Group public import Mathlib.Order.Filter.CountablyGenerated public import Mathlib.Tactic.GCongr import Mathlib.Algebra.Order.Group.Basic
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Order_Filter_AtTopBot_Group(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Order_Filter_AtTopBot_Archimedean(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Order_Filter_AtTopBot_Group(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
