...
// Module: Mathlib.Order.Filter.IndicatorFunction
// Imports: public import Init public import Mathlib.Algebra.Group.Indicator public import Mathlib.Order.CompleteLattice.Finset public import Mathlib.Order.ConditionallyCompleteLattice.Basic public import Mathlib.Order.Filter.AtTopBot.Defs public import Mathlib.Order.Filter.Tendsto
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Order_Filter_AtTopBot_Defs(uint8_t builtin);
lean_object* initialize_mathlib_Mathlib_Order_Filter_Tendsto(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Order_Filter_IndicatorFunction(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Order_Filter_AtTopBot_Defs(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
