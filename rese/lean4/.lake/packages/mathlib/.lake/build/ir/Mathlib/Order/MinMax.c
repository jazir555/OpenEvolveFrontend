...
// Imports: public import Init public import Mathlib.Logic.OpClass public import Mathlib.Order.Lattice
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Order_MinMax(uint8_t builtin) {
lean_object * res;
