...
// Imports: public import Init public import Mathlib.Data.Nat.Basic public import Mathlib.Data.Int.Order.Basic public import Mathlib.Logic.Function.Iterate public import Mathlib.Order.Compare public import Mathlib.Order.Max public import Mathlib.Order.Monotone.Defs public import Mathlib.Order.RelClasses public import Mathlib.Tactic.Choose public import Mathlib.Tactic.Contrapose
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Order_Compare(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Order_Monotone_Basic(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Order_Compare(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
