...
// Imports: public import Init public import Mathlib.Data.Set.Function public import Mathlib.Order.Bounds.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Order_WellFounded(uint8_t builtin) {
lean_object * res;
