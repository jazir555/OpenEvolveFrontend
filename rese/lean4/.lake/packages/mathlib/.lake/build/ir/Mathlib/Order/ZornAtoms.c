...
// Imports: public import Init public import Mathlib.Order.Zorn public import Mathlib.Order.Atoms
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Order_ZornAtoms(uint8_t builtin) {
lean_object * res;
