...
// Module: Mathlib.RingTheory.Localization.Away.Basic
// Imports: public import Init public import Mathlib.GroupTheory.MonoidLocalization.Away public import Mathlib.Algebra.Algebra.Pi public import Mathlib.RingTheory.Ideal.Maps public import Mathlib.RingTheory.Localization.Basic public import Mathlib.RingTheory.UniqueFactorizationDomain.Multiplicity
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_GroupTheory_MonoidLocalization_Away(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_RingTheory_Localization_Away_Basic(uint8_t builtin) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_GroupTheory_MonoidLocalization_Away(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
