...
// Module: Mathlib.RingTheory.Polynomial.Nilpotent
// Imports: public import Init public import Mathlib.Algebra.Polynomial.AlgebraMap public import Mathlib.Algebra.Polynomial.Div public import Mathlib.Algebra.Polynomial.Identities public import Mathlib.RingTheory.Ideal.Quotient.Operations public import Mathlib.RingTheory.Nilpotent.Basic public import Mathlib.RingTheory.Nilpotent.Lemmas
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Algebra_Polynomial_Identities(uint8_t builtin);
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_RingTheory_Polynomial_Nilpotent(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Algebra_Polynomial_Identities(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
