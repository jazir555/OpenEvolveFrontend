...
// Imports: public import Init public import Mathlib.Topology.EMetricSpace.Pi
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Topology_EMetricSpace_Diam(uint8_t builtin) {
lean_object * res;
