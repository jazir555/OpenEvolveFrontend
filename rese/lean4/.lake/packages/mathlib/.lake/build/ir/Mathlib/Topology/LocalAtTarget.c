...
// Imports: public import Init public import Mathlib.Topology.Homeomorph.Lemmas public import Mathlib.Topology.Sets.OpenCover public import Mathlib.Topology.LocallyClosed public import Mathlib.Topology.Maps.Proper.Basic
#include <lean/lean.h>
...
lean_object* initialize_mathlib_Mathlib_Topology_LocallyClosed(uint8_t builtin);
lean_object* initialize_mathlib_Mathlib_Topology_Maps_Proper_Basic(uint8_t builtin);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Topology_LocalAtTarget(uint8_t builtin) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_mathlib_Mathlib_Topology_LocallyClosed(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
