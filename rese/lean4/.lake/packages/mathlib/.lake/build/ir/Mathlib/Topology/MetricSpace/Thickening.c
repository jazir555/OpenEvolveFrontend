...
// Imports: public import Init public import Mathlib.Topology.MetricSpace.HausdorffDistance
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Topology_MetricSpace_Thickening(uint8_t builtin) {
lean_object * res;
