...
// Imports: public import Init public import Mathlib.Topology.UniformSpace.Pi
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Topology_Metrizable_Basic(uint8_t builtin) {
lean_object * res;
