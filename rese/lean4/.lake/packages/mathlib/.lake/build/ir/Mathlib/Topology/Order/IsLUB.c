...
// Imports: public import Init public import Mathlib.Topology.Order.LeftRightNhds
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Topology_Order_IsLUB(uint8_t builtin) {
lean_object * res;
