...
// Imports: public import Init public import Mathlib.Topology.Order.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Topology_Order_MonotoneConvergence(uint8_t builtin) {
lean_object * res;
