...
// Imports: public import Init public import Mathlib.Topology.ContinuousOn
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Topology_Piecewise(uint8_t builtin) {
lean_object * res;
