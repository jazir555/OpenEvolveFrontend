...
// Imports: public import Init public import Mathlib.Topology.UniformSpace.Cauchy
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_mathlib_Mathlib_Topology_UniformSpace_UniformConvergence(uint8_t builtin) {
lean_object * res;
