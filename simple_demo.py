...
def simple_demo():
    ...
    result1 = cache_optimizer.apply_optimization(sample_data, context)
    first_call_time = time.time() - start_time
    
    start_time = time.time()
    result2 = cache_optimizer.apply_optimization(sample_data, context)
