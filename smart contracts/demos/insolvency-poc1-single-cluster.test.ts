...
describe('POC 1: Single-Cluster Insolvency Attack (ACTUAL PROTOCOL)', () => {
  ...
  it('SHOULD prove single-cluster insolvency using ACTUAL protocol', async () => {
    ...
    console.log(`User A deposited: ${Number(depositA / 10n**18n)} SSV (healthy cluster)`);
    console.log(`User B deposited: ${Number(depositB / 10n**18n)} SSV (will bankrupt)`);
    ...
    console.log(`User A is entitled to: ${Number(depositA / 10n**18n)} SSV`);
    ...
    if (deficit > 0) {
      ...
      console.log('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!');
      console.log(`\nUSER A LOSS: ${Number(deficit / 10n**18n)} SSV`);
    ...
    console.log(`User A Entitlement: ${Number(depositA / 10n**18n)} SSV`);
    console.log(`User A Loss: ${Number(deficit / 10n**18n)} SSV`);
    console.log('=================================================================\n');
