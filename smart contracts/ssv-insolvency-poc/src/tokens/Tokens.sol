...
library EthereumTokens {
    ...
    IERC20 public constant ST_ETH = IERC20(0xae7ab96520DE3A18E5e111B5EaAb095312D7fE84);
    IERC20 public constant ANY_LTC = IERC20(0x0aBCFbfA8e3Fda8B7FBA18721Caf7d5cf55cF5f5);
    ...
    IERC20 public constant A_AAVE = IERC20(0xba3D9687Cf50fE253cd2e1cFeEdE1d6787344Ed5);
    ...
    IERC20 public constant W_MANA = IERC20(0xFd09Cf7cFffa9932e33668311C4777Cb9db3c9Be);
    ...
    IERC20 public constant C_USDC = IERC20(0x39AA39c021dfbaE8faC545936693aC917d5E7563);
    ...
    IERC20 public constant XA_UT = IERC20(0x68749665FF8D2d112Fa859AA293F07A622782F38);
    IERC20 public constant C_DAI = IERC20(0x5d3a536E4D6DbD6114cc1Ead35777bAB948E3643);
    ...
    IERC20 public constant C_ETH = IERC20(0x4Ddc2D193948926D02f9B1fE9e1daa0718270ED5);
    ...
    IERC20 public constant STE_CRV = IERC20(0x06325440D014e39736583c165C2963BA99fAf14E);
...
library BinanceTokens {
    ...
    IERC20 public constant ANY_USDC = IERC20(0x8965349fb649A33a30cbFDa057D8eC2C48AbE2A2);
    ...
    IERC20 public constant BT_TP = IERC20(0x8595F9dA7b868b1822194fAEd312235E43007b49);
...
library PolygonTokens {
    ...
    IERC20 public constant LINK_B = IERC20(0x53E0bca35eC356BD5ddDFebbD1Fc0fD03FaBad39);
...
library AvalancheTokens {
    ...
    IERC20 public constant USD_TE = IERC20(0xc7198437980c041c805A1EDcbA50c1Ce5db95118);
    IERC20 public constant US_DT = IERC20(0x9702230A8Ea53601f5cD2dc00fDBc13d4dF4A8c7);
    IERC20 public constant USD_CE = IERC20(0xA7D7079b0FEaD91F3e65f86E8915Cb59c1a4C664);
    IERC20 public constant USDC = IERC20(0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E);
    IERC20 public constant BUS_DE = IERC20(0x19860CCB0A68fd4213aB9D8266F7bBf05A8dDe98);
    IERC20 public constant BUSD = IERC20(0x9C9e5fD8bbc25984B178FdCE6117Defa39d2db39);
    IERC20 public constant DA_IE = IERC20(0xd586E7F844cEa2F87f50152665BCbc2C279D8d70);
    IERC20 public constant SHI_BE = IERC20(0x02D980A0D7AF3fb7Cf7Df8cB35d9eDBCF355f665);
    IERC20 public constant UN_IE = IERC20(0x8eBAf22B6F053dFFeaf46f4Dd9eFA95D89ba8580);
    IERC20 public constant WAVAX = IERC20(0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7);
    IERC20 public constant WBT_CE = IERC20(0x50b7545627a5162F82A992c33b87aDc75187B218);
    IERC20 public constant LIN_KE = IERC20(0x5947BB275c521040051D82396192181b413227A3);
    IERC20 public constant FRAX = IERC20(0xD24C2Ad096400B6FBcd2ad8B24E7acBc21A1da64);
    IERC20 public constant AAV_EE = IERC20(0x63a72806098Bd3D9520cC43356dD78afe5D386D9);
    ...
    IERC20 public constant SN_XE = IERC20(0xBeC243C995409E6520D7C41E404da5dEba4b209B);
    IERC20 public constant GR_TE = IERC20(0x8a0cAc13c7da965a312f08ea4229c37869e85cB9);
    IERC20 public constant MK_RE = IERC20(0x88128fd4b259552A9A1D457f435a6527AAb72d42);
    IERC20 public constant CR_VE = IERC20(0x249848BeCA43aC405b8102Ec90Dd5F22CA513c06);
    IERC20 public constant FXS = IERC20(0x214DB107654fF987AD859F34125307783fC8e387);
    IERC20 public constant ONEINC_HE = IERC20(0xd501281565bf7789224523144Fe5D98e8B28f267);
    IERC20 public constant BA_TE = IERC20(0x98443B96EA4b0858FDF3219Cd13e98C7A4690588);
    IERC20 public constant SUSH_IE = IERC20(0x37B608519F91f70F2EeB0e5Ed9AF4061722e4F76);
    IERC20 public constant COM_PE = IERC20(0xc3048E19E76CB9a3Aa9d77D8C03c29Fc906e2437);
    IERC20 public constant YF_IE = IERC20(0x9eAaC1B23d935365bD7b542Fe22cEEe2922f52dc);
    IERC20 public constant ZR_XE = IERC20(0x596fA47043f99A4e0F122243B841E55375cdE0d2);
    IERC20 public constant UM_AE = IERC20(0x3Bd2B1c7ED8D396dbb98DED3aEbb41350a5b2339);
    ...
    IERC20 public constant BT_CB = IERC20(0x152b9d0FdC40C096757F570A51E494bd4b943E50);
    ...
    IERC20 public constant ALPH_AE = IERC20(0x2147EFFF675e4A4eE1C2f918d181cDBd7a8E208f);
    ...
    IERC20 public constant X_JOE = IERC20(0x57319d41F71E81F3c65F2a47CA4e001EbAFd4F33);
    ...
    IERC20 public constant SWA_PE = IERC20(0xc7B5D72C836e718cDA8888eaf03707fAef675079);
    ...
    IERC20 public constant S_JADE = IERC20(0x3D9eAB723df76808bB84c05b20De27A2e69EF293);
...
library FantomTokens {
    ...
    IERC20 public constant W_BAN = IERC20(0xe20B9e246db5a0d21BF9209E4858Bc9A3ff7A034);
    IERC20 public constant HEC = IERC20(0x5C4FDfc5233f935f20D2aDbA572F770c2E377Ab0);
    IERC20 public constant S_HEC = IERC20(0x75bdeF24285013387A47775828bEC90b91Ca9a5F);
    IERC20 public constant TOMB = IERC20(0x6c021Ae822BEa943b2E66552bDe1D2696a53fbB7);
    IERC20 public constant FM_XEN = IERC20(0xeF4B763385838FfFc708000f884026B8c0434275);
...
library OptimismTokens {
    ...
    IERC20 public constant S_USD = IERC20(0x8c6f28f2F1A3C87F0f938b96d27520d9751ec8d9);
    IERC20 public constant BIFI = IERC20(0x4E720DD3Ac5CFe1e1fbDE4935f386Bb1C66F4642);
    IERC20 public constant S_ETH = IERC20(0xE405de8F52ba7559f9df3C368500B6E6ae6Cee49);
    ...
    IERC20 public constant S_BTC = IERC20(0x298B9B95708152ff6968aafd889c6586e9169f1D);
    ...
    IERC20 public constant S_LINK = IERC20(0xc5Db22719A06418028A40A9B5E9A7c02959D0d08);
...
library GnosisTokens {
    ...
    IERC20 public constant X_MOON = IERC20(0x1e16aa4Df73d29C029d94CeDa3e3114EC191E25A);
    ...
    IERC20 public constant ZEROX_MR = IERC20(0x8c88eA1fD60462Ef7004B9e288afCB4680a3c50c);
    ...
    IERC20 public constant WETH_GNOSIS = IERC20(0x6A023CCd1ff6F2045C3309768eAd9E68F978f6e1);
    IERC20 public constant HNY = IERC20(0x71850b7E9Ee3f13Ab46d67167341E4bDc905Eef9);
    IERC20 public constant J_CHF = IERC20(0x2d5563da42b06FbBF9c67b7DC073cF6A7842239e);
    IERC20 public constant J_EUR = IERC20(0x9fB1d52596c44603198fB0aee434fac3a679f702);
    ...
    IERC20 public constant X_COMB = IERC20(0x38Fb649Ad3d6BA1113Be5F57B927053E97fC5bF7);
