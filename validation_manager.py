...
class ValidationManager:
    ...
    def validate_content_against_custom_rules(self, content: str, rule_names: List[str]) -> Dict:
        """
    ...
    def run_compliance_check(self, content: str, compliance_framework: str = "generic") -> Dict:
        """
        ...
        return self._apply_single_rule(
            content, 
            self.validation_rules.get(compliance_framework, self.validation_rules.get("generic", {})), 
