...
class VersionControl:
    ...
    def create_new_version(self, protocol_text: str, version_name: str = "", comment: str = "") -> str:
        """
    ...
    def delete_version(self, version_id: str) -> bool:
        ...
        try:
            with st.session_state.thread_lock:
                ...
                if st.session_state.get("current_version_id") == version_id and st.session_state.protocol_versions:
    ...
    def compare_versions(self, version_id_1: str, version_id_2: str) -> Dict:
        ...
        try:
            ...
            chars_removed = abs(len(text1) - len(text2)) if len(text1) > len(text2) else 0
